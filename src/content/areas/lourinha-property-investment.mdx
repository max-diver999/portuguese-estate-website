...
readingTime: 30
segment: invest
heroImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Cruzeiro_do_Castelo_-_Lourinh%C3%A3_-_Portugal_%2852742393585%29.jpg/1280px-Cruzeiro_do_Castelo_-_Lourinh%C3%A3_-_Portugal_%2852742393585%29.jpg"
heroImageAlt: "Cruzeiro do Castelo - Lourinhã - Portugal — Lourinhã, Silver Coast"
heroImageCredit: "Vitor Oliveira from Torres Vedras, PORTUGAL / Wikimedia Commons"
heroImageLicence: "CC BY-SA 2.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Cruzeiro_do_Castelo_-_Lourinh%C3%A3_-_Portugal_(52742393585).jpg"
faq:
...
<TldrBlock text="Lourinhã €2,400-3,200/m² western Silver Coast value entry. Gross yields 4.5-5.5% long-term; AL selective on beach and Dino Parque weekends. Dinosaur coast branding + rural-coastal mix; French/British retiree tenant core. Thinner liquidity vs Caldas/Óbidos; compare Ericeira surf premiums. Non-resident IMT flat 7.5% from Sep 2026. Net yields: use gross-vs-net guide." />
...
<InlineCta
  headline="Want a Lourinhã shortlist matched to your budget?"
  subtext="Tell us budget, financing and rental goal. We send Lourinhã options with price per m2, yield math and licence status within one business day."
  ctaId="area_mid_lourinha_property_investment"
  whatsappMessage="Hi Portuguese Estate! I'm researching Lourinhã property and I'd like a shortlist matched to my budget."
/>
...
Lourinhã's entry prices keep total acquisition cost low in absolute terms, but the non-resident rate is flat rather than progressive, so the percentage does not fall with the price. See [IMT for non-residents](/guides/imt-tax-non-resident-portugal-2026/).
...
## Portuguese Estate advisory: Lourinhã pre-contract checklist

Portuguese Estate publishes data-led guides; cross-border advisory on western Costa de Prata acquisitions is supported by the Portuguese Estate desk, which stress-tests deals against INE market data, AT tax simulations and Lourinhã municipal policy before clients sign CPCV deposits. The checklist below is unique to Lourinhã rural-coastal stock and is not a substitute for lawyer-led due diligence.

**Portuguese Estate Lourinhã investor checklist (verify before CPCV):**
...
Coastal parcels in Lourinhã can carry setback and erosion constraints inland ones do not. Use [how to buy property step by step](/guides/how-to-buy-property-portugal-step-by-step/) and the budget frame in [property under €300,000](/guides/portugal-property-under-300000-euros/).
