...
5. **Resale narrative:** Dinosaur coast branding helps agents market to French and British buyers documented in [French buyers Portugal property](/move-to-portugal/by-nationality/); it does not guarantee fast exit on overpriced inland stock.
...
Cross-read [French buyers Portugal property](/move-to-portugal/by-nationality/) for national segment context that maps directly onto Lourinhã rental pools and resale statistics.
...
Platform economics add 3-5% where not absorbed by managers. Beach-adjacent apartment maintenance is predictable compared to Ericeira cliff terraces exposed to Atlantic storm exposure. Model net yields only through the [gross vs net yield in Portugal](/guides/portugal-rental-yield-guide/) framework rather than gross brochures.
...
5. **French / UK buyer admin:** Cross-read [French buyers Portugal property](/move-to-portugal/by-nationality/) for segment-specific NIF and tax paths.
...
10. **Net yield worksheet:** Run [gross vs net yield in Portugal](/guides/portugal-rental-yield-guide/) before trusting summer ADR marketing.
