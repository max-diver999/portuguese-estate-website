...
readingTime: 22
segment: invest
heroImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Igreja_Matriz_de_Portimao_2_-_Portimao%2C_Algarve_-_Portugal.jpg/1280px-Igreja_Matriz_de_Portimao_2_-_Portimao%2C_Algarve_-_Portugal.jpg"
...
Portimão splits between the working town and Praia da Rocha, and the licensing position differs across that line. Establish which side of it an address sits on before modelling either long or short letting.
...
Off-plan stock in Portimão is concentrated in larger blocks, so verify the alvará de construção, the phasing plan and the draft condominium budget together: the third of those decides the running cost of the first two.
...
<InlineCta
  headline="Want a Portimão shortlist matched to your budget?"
  subtext="Tell us budget, financing and rental goal. We send Portimão options with price per m2, yield math and licence status within one business day."
  ctaId="area_mid_portimao_property_investment"
  whatsappMessage="Hi Portuguese Estate! I'm researching Portimão property and I'd like a shortlist matched to my budget."
/>
...
Portimão's buyer mix straddles the two INE categories. Non-resident purchases, meaning tax domicile abroad, totalled 8,471 nationally and fell 13.3%, while purchases by foreign-born residents grew. Commentary that merges the two overstates the retreat in this municipality.
...
Portimão splits between the town and Praia da Rocha, and the two price and let on different logic. Follow [due diligence](/guides/due-diligence-portugal-property/) and compare yields through [highest rental yield areas](/guides/highest-rental-yield-areas-portugal/).
...
## Portuguese Estate advisory: Portimão pre-contract checklist

Portuguese Estate publishes data-led guides; cross-border advisory on high-value Portimão acquisitions is supported by the Portuguese Estate desk, which stress-tests deals against INE and AICCOPN market data, AT tax simulations, and municipal AL reality before clients sign CPCV deposits. The checklist below is unique to Portimão holiday stock and is not a substitute for lawyer-led due diligence.

**Portuguese Estate Portimão investor checklist (verify before CPCV):**
...
## What a Portimão purchase costs and returns

A worked cash-to-close and net yield for Portimão runs as follows, on a 90 m² two-bedroom at the €3,700/m² mid-point of the local range. Purchase price €333,000. A non-resident completing from 1 September 2026 pays flat 7.5% IMT of €24,975 under DL 97/2026, 0.8% stamp duty of €2,664, and roughly 2.5% in legal, notary and registry fees of €8,325 — €35,964 of costs on top of the price, or 10.8%. Total capital deployed is €368,964. At the 5.2% mid-point of the local gross range the unit lets for about €1,457 a month, €17,482 a year. Deducting IMI of €932, condominium charges of €1,200, management at 10% (€1,748) and a maintenance reserve of €1,049 leaves €12,553 net, or 3.4% cash-on-cash before income tax. That gap between the 5.2% headline and 3.4% realised is the number to underwrite on.
