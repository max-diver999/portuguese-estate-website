...
Hybrid strategies — long-term base tenant October-May plus owner use or selective AL in peak weeks — appear frequently among British and French second-home owners documented in the [UK buyers Portugal property after Brexit](/move-to-portugal/from-uk/) segment guide, but hybrid models require explicit condominium permission and careful tax reporting. See [long-term vs holiday rental in Portugal](/guides/long-term-vs-holiday-rental-portugal/) before committing to either path in the CPCV.
...
Cross-read [French buyers Portugal property](/move-to-portugal/by-nationality/) for national segment context that maps directly onto Costa de Prata resale pools.
...
Platform economics add 3-5% where not absorbed by managers. Storm-season maintenance on cliff-facing terraces and funicular-adjacent access roads are recurring lines inland Caldas apartments rarely carry at the same intensity. Model net yields only through the [gross vs net yield in Portugal](/guides/portugal-rental-yield-guide/) framework rather than gross brochures.
...
4. **UK / French buyer admin:** British purchasers verify fiscal representative and NIF path per [UK buyers Portugal property after Brexit](/move-to-portugal/from-uk/); French buyers cross-check DTA reporting.
...
9. **Net yield worksheet:** Run [gross vs net yield in Portugal](/guides/portugal-rental-yield-guide/) before trusting event-week ADR marketing.
