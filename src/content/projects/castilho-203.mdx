...
readingTime: 14
heroImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/Building_fa%C3%A7ade_water_reflection%2C_Jardim_Norte_da_Caixa_Geral_de_Dep%C3%B3sitos%2C_Lisbon%2C_Portugal_julesvernex2-2.jpg/1280px-Building_fa%C3%A7ade_water_reflection%2C_Jardim_Norte_da_Caixa_Geral_de_Dep%C3%B3sitos%2C_Lisbon%2C_Portugal_julesvernex2-2.jpg"
heroImageAlt: "Building façade water reflection, Jardim Norte da Caixa Geral de Depósitos, Lisbon, Portugal-2 — Avenidas Novas, Lisbon"
heroImageCredit: "Jules Verne Times Two / Wikimedia Commons"
heroImageLicence: "CC BY-SA 4.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Building_fa%C3%A7ade_water_reflection,_Jardim_Norte_da_Caixa_Geral_de_Dep%C3%B3sitos,_Lisbon,_Portugal_julesvernex2-2.jpg"
...
Quick Answer: Castilho 203 is a completed apartment scheme by Vanguard Properties in Castilho street, Avenidas Novas. Completed benchmark for Vanguard build quality and AML luxury resale depth. Foreign buyers follow standard CPCV and escritura rules; non-residents completing after 1 September 2026 pay flat 7.5% IMT under DL 97/2026. Off-plan payments require Decreto-Lei 67/2003 bank guarantees. This is editorial due diligence, not a buy recommendation.

<TldrBlock text="TL;DR: Vanguard Properties · Castilho street, Avenidas Novas · completed. 19 ultra-premium apartments. Handover/target: delivered. Non-resident IMT flat 7.5% from Sep 2026. Off-plan: DL 67/2003 guarantee on every pre-deed payment. Independent lawyer mandatory. Compare [off-plan guide](/guides/off-plan-property-portugal-guide/) and [developer review](/developers/vanguard-properties-portugal/)." />

Castilho 203 sits in Castilho street, Avenidas Novas, one of the addresses foreign buyers research when comparing Lisbon, Porto, Comporta and Algarve capital stock. Developer marketing emphasises design, amenities and location narrative. Investor underwriting must separate render from registered plans, verify seller legal identity, and model tax timing at escritura.
...
## What is Castilho 203?

Castilho 203 is developed by Vanguard Properties as 19 ultra-premium apartments. Marketing positions the scheme for completed benchmark for vanguard build quality and aml luxury resale depth. Status in 2026: **completed** with target handover **delivered**.
...
| Type | apartment |
| Status | completed |
| Units (marketing) | 19 ultra-premium apartments |
| Target handover | delivered |

## Where is the project and who is the tenant pool?

Castilho street, Avenidas Novas determines commute patterns, rental seasonality and resale buyer depth. Completed benchmark for Vanguard build quality and AML luxury resale depth. Cross-read the relevant area or city guide: [Lisbon property investment](/guides/lisbon-property-investment-guide/), [Porto property investment](/guides/porto-property-investment-guide/), [Algarve property investment](/guides/algarve-property-investment-guide/), [Comporta property investment](/areas/comporta-property-investment/), or [Faro property investment](/areas/faro-property-investment/) as applicable.
...
List prices change by phase and unit. Developer materials at publish time should be treated as indicative; request written price list before reservation. Where marketing cites **from €1200K**, confirm exact unit, floor, parking and storage line items.
...
| Castilho street, Avenidas Novas location narrative for target buyer pool | Off-plan delay risk on permits and fit-out |
...
## Who should consider Castilho 203?

Suits buyers who want apartment exposure in Castilho street with Vanguard Properties delivery context and can tolerate resale premium and condominium costs. Suits less well pure yield hunters needing immediate cash flow without void period, or buyers who cannot verify guarantees before deposit.
