---
title: "Porto AL Licence 2026: 5 Frozen Parishes, Open Zones"
description: "Porto blocks new AL licences in 5 historic parishes in 2026 at the 15% pressure cap. Which outer parishes stay open, condo veto rules, and pre-CPCV checks."
pubDate: 2026-06-17
...
segment: invest
featured: false
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/portugal/guides/porto-alojamento-local-rules/hero.webp"
heroImageAlt: "The historic centre of Porto"
heroImageCredit: "xiquinhosilva / Wikimedia Commons"
heroImageLicence: "CC BY 2.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Historic_Centre_of_Porto_(53938709332).jpg"
heroImageWidth: 1280
heroImageHeight: 823
faq:
...
Quick Answer: Porto freezes new Alojamento Local licences in 5 historic-core parishes in 2026: Santo Ildefonso, Sé, Miragaia, São Nicolau, and Vitória. A parish enters containment once AL reaches a 15% pressure ratio. Outer parishes including Bonfim, Cedofeita, Campanhã, Paranhos, and Ramalde stay open with a 60-day municipal opposition window. Condominium assemblies can veto AL in buildings with four or more fractions, and Lisbon applies a stricter 10% RMAL cap. Verify parish status on the Portal do Munícipe before you sign a CPCV.

<TldrBlock text="Porto historic core (five freguesias) = containment at 15% pressure ratio, no routine new AL. Outer parishes (Bonfim, Cedofeita, Campanhã, Paranhos, Ramalde, Foz, etc.) = sustainable growth, 60-day municipal window. DL 76/2024 + Reg. 1462/2024. Condominium 2/3 veto nationwide. Lisbon RMAL stricter at 10%. Matosinhos/Gaia = separate councils. RNAL + municipal doc + insurance mandatory. Model long-term yield in contained core; AL in open parishes only after written confirmation." />
...
Decree-Law 76/2024 is the national backbone every Porto AL application must satisfy regardless of parish openness. It reopened registrations that were frozen from November 2023, returned density control to municipalities, removed the five-year expiry cycle, and made liability insurance compulsory from March 2025. The provisions that most affect buyers in 2026:
...
In the historic core, parishes face the strictest AL limits because tourism penetration pushed the pressure ratio to 15% or above. Five freguesias are in containment as of the 2024 regulation and the February 2026 portal update, while Bonfim, Cedofeita, Campanhã, Paranhos, Ramalde, and Foz do Douro remain in sustainable growth. The contained five are:
...
In Foz do Douro, sustainable growth classification does not mean automatic approval. High-value condominiums near the ocean frequently pass anti-AL assembly resolutions. Always cross-check parish map status with condominium minutes.
...
<InlineCta
  ...
  ctaId="guide_mid_porto_alojamento_local_rules"
...
The 15% threshold is Porto's defining difference from Lisbon's 10% RMAL cap. Porto measures AL establishments against water-metered residential fractions at freguesia level, a wider unit than the Lisbon subsection, so a single street of guest apartments moves the Porto ratio far less than it moves the Lisbon one. Calculation methodology under Regulamento 1462/2024:
...
SIIAL publishes the underlying counts. Investors and solicitors should pull the current ratio for the target freguesia in the same week as CPCV; a map screenshot from a prior year is no substitute.
...
Porto requires municipal approval before national RNAL registration, which reverses the order buyers assume. The sequence runs: confirm the parish position, obtain municipal consent, then register on the RNAL. Starting at the national register wastes weeks and produces no valid licence.
...
Insider tip: pull SIIAL pressure data and condominium minutes in the same calendar week you pay the CPCV deposit, because data pulled at first viewing will be stale by then. Agents often market historic-core flats using sustainable-growth comps from Bonfim or Cedofeita.
...
Porto splits into contained parishes where new AL registrations are blocked and open ones where they are not, and the price gap between them rarely reflects the licensing gap. Overpaying for a historic-core property on income the buyer cannot legally replicate is the standard Porto error.
...
The buyer inherits long-term rent economics, whatever STR screenshots the listing shows.
...
For yield mathematics, always compare net figures using the [Portugal rental yield guide](/guides/portugal-rental-yield-guide/) and the [gross versus net yield explainer](/guides/portugal-rental-yield-guide/) instead of relying on platform gross alone.

## Porto versus Lisbon RMAL: side-by-side comparison for 2026

Porto and Lisbon run different short-let regimes and are not interchangeable on policy. Lisbon's RMAL applies mathematical caps at freguesia level across the whole municipality; Porto's containment covers a defined set of parishes and leaves the outer city materially more open.
...
Porto permits narrow mayoral exceptions inside its 5 contained freguesias, granted against urban policy objectives rather than on request. These are not a route for a standard investor acquisition, and no purchase should be underwritten on the assumption that one will be granted.
...
Porto's municipal boundary excludes several places marketed as Porto investments. Vila Nova de Gaia and Matosinhos are separate municipalities with their own AL policies, their own IMI rates and their own licensing queues, and a Porto answer does not apply to either.

Along the Douro waterfront, the riverside parishes of Vila Nova de Gaia face separate containment pressure. Inland Gaia parishes such as Mafamude and Canidelo often remain more open but require Gaia Câmara registration.
...
Any Porto purchase where short-let income carries the thesis needs 3 scenarios modelled before the CPCV: the AL licence granted, the licence refused with long-term letting as the fallback, and the property held empty. If the deal only works in the first, it is not a deal.
...
Scenario B looks superior on gross, but regulatory and condominium risk must be zeroed before offer. The trap is Scenario A: paying Scenario B prices for Scenario C income because the listing showed the seller's AL calendar.

Use the [how to calculate rental yield Portugal](/guides/portugal-rental-yield-guide/) walkthrough and compare AL versus long-term paths in [long-term versus holiday rental Portugal](/guides/long-term-vs-holiday-rental-portugal/).
...
## How does Porto AL licensing work in practice?

Porto acquisitions are routinely mispriced at offer stage because AL status is assumed rather than verified. An existing licence does not transfer on sale under DL 76/2024, so a seller's operating history is evidence of what was possible, not of what a buyer will be granted.
...
Buyers blocked from AL in a containment parish still have income routes: long-term letting under the NRAU at a flat 28% on net income for non-residents, medium-term corporate and student lets, or a purchase in an open outer parish where the licence is available.
...
Shift strategy to buy-to-let planning in the [Portugal buy-to-let investment guide](/guides/portugal-property-investment-guide/) with AL as upside only after verification.
