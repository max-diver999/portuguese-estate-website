...
segment: invest
featured: false
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/porto-alojamento-local-rules/hero"
...
For yield mathematics, always compare net figures using the [Portugal rental yield guide](/guides/portugal-rental-yield-guide/) and the [gross versus net yield explainer](/guides/portugal-rental-yield-guide/), not platform gross alone.
...
Pivot strategy to buy-to-let planning in the [Portugal buy-to-let investment guide](/guides/portugal-property-investment-guide/) with AL as upside only after verification.
