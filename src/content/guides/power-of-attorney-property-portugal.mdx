---
title: "Portugal Property Power of Attorney 2026: €350-900"
description: "A procuração costs €350-900 in 2026 and lets your lawyer sign the CPCV and escritura without your travel. Consulate vs notary, apostille steps, scope limits."
pubDate: 2026-06-17
...
readingTime: 20
featured: true
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/power-of-attorney-property-portugal/hero"
heroImageAlt: "The façade of the Tribunal da Relação in Coimbra"
heroImageCredit: "Alexkom000 / Wikimedia Commons"
heroImageLicence: "CC BY 4.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:2025-10-04_Beach_north_of_Ferrel_03.jpg"
heroImageWidth: 1280
heroImageHeight: 853
relatedSlugs:
...
Quick Answer: A Portuguese property procuração (power of attorney) costs €350 to €900 in 2026 and takes 5 to 21 days to notarise, apostille, and courier. It lets a licensed Portuguese lawyer sign the CPCV, pay IMT, and complete the escritura without your travel. The POA must be drafted in Portuguese, signed before a notary or consulate abroad, apostilled under the Hague Convention, and scoped to specific acts. It authorises execution, not property choice, and you still approve the CPCV on video before your lawyer signs.

<TldrBlock text="Lawyer drafts scoped procuração in Portuguese → you sign before home-country notary or Portuguese consulate → apostille if abroad → lawyer uses POA for NIF coordination, bank KYC, CPCV signature, due diligence, IMT payment, and escritura attendance. Consulate vs local notary is a timing choice, not a legal hierarchy. Never sign a blank POA. Pair with lawyer escrow and suspensive CPCV clauses. See remote buying guide for full timeline." />
...
You need a procuração whenever you will not be physically present for a signature the purchase requires. In practice, remote buyers use one scoped POA across multiple phases: NIF filings, bank onboarding, the CPCV with its 10-30% deposit, IMT payment, and the escritura itself, which spans roughly 8 to 14 weeks.
...
Execution location is a logistics choice rather than a legal hierarchy. Validity depends on correct form, apostille where required, and acceptance by your lawyer, bank, and notary. Allow 5 to 21 days end to end for notarisation, apostille, and courier, and longer where consulate appointments in London, Paris, or São Paulo run weeks behind.
...
<InlineCta
  ...
  ctaId="guide_mid_power_of_attorney_property_portugal"
...
Documents executed abroad must be usable before Portuguese notaries, Conservatória do Registo Predial, Autoridade Tributária, and banks. Three steps make that work: notarisation of the Portuguese text, a Hague apostille from the issuing country, and certified translation where the notary requires it. Budget 5 to 21 days and €350 to €900 in total for a purchase POA.
...
The CPCV binds price, deposit, completion date and the penalty regime, which makes it the highest-risk document a procurador signs on your behalf. A deposit of 10% to 30% moves on that signature, so the power of attorney must be in force and correctly scoped before the contract is drafted.
...
The escritura pública de compra e venda is the deed that transfers ownership, and a correctly scoped procuração lets your lawyer execute it without you present. The notary checks the instrument's scope and validity before accepting the signature, which is why drafting matters more than convenience.
...
Banks apply their own KYC policies on top of civil law, and those policies are stricter. A procuração valid for the CPCV and the escritura does not automatically satisfy a bank's internal rules for opening an account or drawing a mortgage, and several require the account holder to appear once in person.
...
A power of attorney concentrates the authority to move money and transfer title into one person's hands, which is exactly why the scope matters. Narrow the acts to the specific transaction, name the property, set an expiry date, and never grant a general instrument for a single purchase.
...
Complexity rises with the number of parties. Two buyers need two instruments unless one grants authority to the other, a married couple's marriage property regime affects what each may sign alone, and a corporate buyer needs evidence of the signatory's authority alongside the procuração itself.
...
## Every POA failure is a timing failure

This page is editorial and does not provide legal advice or draft procurações. The failure modes below recur because each one is a timing problem rather than a drafting problem:
...
Return to the [foreign buyer hub](/guides/how-to-buy-property-portugal-step-by-step/) for IMT 7.5% non-resident rules under DL 97/2026, total buying costs, and the full sequence from NIF to registered title. For step-by-step chronology, see [how to buy property in Portugal step by step](/guides/how-to-buy-property-portugal-step-by-step/).

## What a procuração costs and what it should not permit

A power of attorney is standard for remote Portuguese purchases and typically costs €200 to €600, drawn by a Portuguese lawyer, signed before a notary in your own country and apostilled under the Hague Convention. Turnaround runs one to three weeks depending on the consulate, which is why it is arranged before an offer rather than after. The scope is where buyers get careless. Limit it to the specific property, the specific transaction and a fixed expiry date. A general power over your affairs in Portugal, granted to an agent or developer's contact rather than your own lawyer, is the single most dangerous document in a remote purchase. Have the procuração drafted by the lawyer who acts for you alone, and revoke it formally at the land registry once the escritura has completed.
