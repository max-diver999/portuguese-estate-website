---
title: "Portugal Golden Visa Investment Funds: 2026 Selection"
description: "How to choose a Portugal Golden Visa fund in 2026: the CMVM rules, the 60% Portuguese asset floor, management charges over five years, and what to ask."
pubDate: 2026-06-17
...
readingTime: 18
featured: false
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/portugal-golden-visa-fund-investment-2026/hero"
heroImageAlt: "An office building in Belém, Lisbon — the Golden Visa fund route"
heroImageCredit: "Sjenghai / Wikimedia Commons"
heroImageLicence: "CC BY-SA 4.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Lisboa_-_Bel%C3%A9m_-_Rua_Dom_Crist%C3%B3v%C3%A3o_da_Gama_-_Edif%C3%ADcio_Restelo_-_2025-05-21.jpg"
heroImageWidth: 1280
heroImageHeight: 960
relatedSlugs:
...
The question this page exists to answer is still asked property-first, because the route that closed in October 2023 is the one most people have heard of. The realistic timetable from decision to CMVM subscription is 10-14 weeks when criminal record apostilles and NIF issuance run in parallel.
...
<InlineCta
  ...
  ctaId="guide_mid_portugal_golden_visa_fund_investment_2026"
...
Golden Visa is a residence permit, not instant citizenship, and the gap between the two widened sharply in 2026. After five years of legal residence with maintained qualifying investment and compliance with stay rules, holders may apply for permanent residency if they pass basic Portuguese language (typically A2 level) and integration requirements. That five-year permanent residency milestone is unchanged.

Citizenship is the part that moved. Lei Orgânica 1/2026, in force since 19 May 2026, requires seven years of legal residence for EU and CPLP nationals and ten years for everyone else, counted from the date the residence permit is issued rather than from the application. Only nationality applications already pending on that date are assessed under the previous wording. AIMA and Conservatória dos Registos Centrais procedures evolve; citizenship is not automatic upon calendar expiry.
...
| Citizenship application | Year 10 for most non-EU nationals, year 7 for EU and CPLP | Language, integration, clean record |
...
| D7 passive income | Income proof (~€920/month+) | Substantial | Retirees with stable pension |
...
## What the fund route costs beyond the €500,000

The headline is €500,000 into a CMVM-regulated fund for a minimum five years, but the all-in figure is higher. Management fees typically run 1% to 2% a year, which over five years consumes €25,000 to €50,000 of the capital before any return. Subscription fees, legal work and the application itself add materially. Against that, the fund route carries no IMT, no stamp duty, no IMI and no AIMI, so it avoids the roughly 10.8% acquisition cost and the annual holding taxes a property incurs. The trade is liquidity: the capital is locked for five years and fund performance is not guaranteed, where property can be sold whenever the market allows. Read the fund's redemption terms carefully: five years is the visa minimum, not necessarily the point at which capital can actually be withdrawn.
