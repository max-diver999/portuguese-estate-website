---
title: "Lisbon Property Market 2026: District Data and Yields"
...
readingTime: 18
segment: invest
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/lisbon-property-investment-guide/hero"
heroImageAlt: "The church of Nossa Senhora do Monte in Lisbon"
heroImageCredit: "David Broad / Wikimedia Commons"
heroImageLicence: "CC BY 3.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Church_of_Nossa_Senhora_do_Monte,_Lisbon,_Portugal_-_panoramio.jpg"
heroImageWidth: 1280
heroImageHeight: 850
faq:
...
For where to buy in Lisbon town by town, with buying and holding costs, start with [property for sale in Lisbon](/property-for-sale/lisbon/). This page is the market data behind that decision.
...
Lisbon's licensing map matters more to a yield model than its price map. New Alojamento Local registrations are suspended across the historic containment zones, so two apartments a few hundred metres apart can carry entirely different income ceilings. Establish which zone an address falls in before underwriting short-let income, and treat long-term letting at 25% autonomous tax as the base case rather than the fallback.
...
Lisbon investment performance is parish-specific rather than city-wide, and the variation inside the municipality exceeds the variation between Portuguese regions. Yield, short-let regulation and tenant profile differ so sharply between a Chiado apartment and a Marvila conversion that a blanket Lisbon strategy has no meaning.
...
French buyers disproportionately compare Príncipe Real against Paris arrondissements and Lyon presqu'île pricing; see our [French buyers segment page](/move-to-portugal/by-nationality/) for nationality-specific financing and tax-domicile notes.
...
Gross yield is annual rent divided by purchase price, and it is what portals quote. Net yield subtracts IMI at 0.3% to 0.45% of rateable value, condominium quotas, insurance, management, voids and the flat 28% tax on net rental income for non-residents. The gap between the two commonly exceeds a third.
...
<InlineCta
  ...
  ctaId="guide_mid_lisbon_property_investment_guide"
...
Greater Lisbon took 12.5% of non-resident transaction volume and 22.2% of non-resident value in 2025, which means foreign buyers here buy fewer properties at higher prices than the national average. Three overlapping cohorts account for that skew, and they want different districts.
...
Compare nationality-specific behaviour in the [French buyers segment](/move-to-portugal/by-nationality/) and legal process in [buy property in Portugal as a foreigner](/guides/how-to-buy-property-portugal-step-by-step/).
...
Lisbon's building stock is old and its legal risk concentrates in two places: pre-1970 historic-centre buildings and 1980s to 1990s conversions. Unregistered extensions, a licença de utilização that does not match the building, registry charges and unpaid condominium debt are the four failures diligence finds.
...
One sequence covers Lisbon-specific diligence before any CPCV, and it runs beyond the national checklist. Confirm the RMAL containment position for the statistical subsection, read 3 years of condominium minutes, verify the licença de utilização against the built area, and check the registry for charges.
...
Full process walkthrough: [buy property in Portugal as a foreigner](/guides/how-to-buy-property-portugal-step-by-step/).

## Where the numbers on this page come from

Prices on this page are drawn from INE's published series and the Câmara's AL bulletins rather than from portal asking prices, which are offers rather than transactions and run ahead of the register. Containment maps are published parish by parish, so a yield scenario built on a city-wide average will misdescribe any specific address inside a zone. If your lawyer's AT simulation conflicts with an example here, trust the simulation: tax domicile and property use class move IMT brackets.

## The Lisbon coast: Cascais, Estoril and Oeiras

| Area | Guide |
|---|---|
| Cascais / Estoril (marina, golf, commuter belt) | [Cascais Property Investment](/property-for-sale/cascais/) |
| Parque das Nações (Expo, corporate tenants) | [Parque das Nações Property](/property-for-sale/lisbon/) |
| Chiado / Príncipe Real (prime, RMAL contained) | [Chiado & Príncipe Real Property](/property-for-sale/lisbon/) |
| Oeiras (Taguspark, family corridor) | [Oeiras Property Investment](/property-for-sale/lisbon/) |
| Lisbon vs Cascais compare | [Lisbon vs Cascais Property Investment](/compare/lisbon-vs-cascais-property/) |
| RMAL containment detail | [Lisbon AL Containment Zones](/guides/lisbon-alojamento-local-containment-zones/) |

## Lisbon east and west: Marvila, Alcântara and beyond

| Area | Guide |
|---|---|
| Marvila / Beato regeneration | [Marvila Property Investment](/property-for-sale/lisbon/) |
| Alcântara / LX Factory docks | [Alcântara Property Investment](/property-for-sale/lisbon/) |
| Chinese buyer segment | [Chinese Buyers Portugal Property](/move-to-portugal/by-nationality/) |

## What a Lisbon purchase returns after costs

Lisbon's headline yields are the lowest of Portugal's major markets and its liquidity is the deepest, which is the trade the city actually offers. A €520,000 two-bedroom in a fringe parish letting at €1,900 a month grosses €22,800, or 4.4%. Acquisition costs add 10.8% (flat 7.5% IMT of €39,000, €4,160 stamp duty and about €13,000 in professional fees), taking capital deployed to €576,160. After IMI near €1,456, condominium of €1,500, management at 10% and a 6% maintenance reserve, net income is about €15,696, or 2.7% cash-on-cash before tax. Buyers accept that number for exit depth and tenant quality, not for income. If income is the objective, Porto and Braga price the same euro differently. Model both before committing to the capital.
