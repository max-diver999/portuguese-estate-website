...
<TldrBlock text="DL 76/2024 lifted the national AL freeze and removed 5-year expiry. Insurance upload on RNAL mandatory since Mar 2025. Lisbon RMAL (Dec 2025): ≥10% licensed housing stock in a freguesia = no new AL; 5–10% = exceptional only; AL expires on sale in containment zones. Porto: historic core tight, outer parishes open. Algarve: broadly open, verify each câmara. RNAL required before listing. STR income typically IRS Category B. Model net yield vs long-term, not gross Airbnb peaks." />
...
Portuguese short-term rental policy changed twice in three years, and sellers routinely quote the older position. Decree-Law 76/2024 is the current national framework, replacing the Mais Habitacao restrictions of 2023, and it restored transferability rules and condominium veto powers that the earlier package had altered.
...
<InlineCta
  ...
  ctaId="guide_mid_alojamento_local_license_portugal"
...
RNAL registration is the non-optional gateway to legal short-let operation in Portugal, and there is no valid pending status permitting paid guest stays during review. Operating without it exposes the owner to fines and to the platform delisting the property.
...
Under Decree-Law 76/2024, insurance documentation on the RNAL portal is not a one-time upload: renewal lapses can suspend the registration even when municipal density caps would otherwise allow operation. Buyers completing under [CPCV promissory contract](/guides/cpcv-promissory-contract-portugal/) terms should require seller proof of current RNAL insurance status as a pre-deposit disclosure, mirroring the same rigour applied to licença de utilização checks in [due diligence Portugal property](/guides/due-diligence-portugal-property/).
...
| Gross yield | N/A | 4.9% |
| IMI, condo, insurance | n/a | -€3,200 |
| Management 10% | n/a | -€2,040 |
| Maintenance 1% | n/a | -€4,200 |
| Tax (non-resident simplified) | n/a | -€3,800 approx. |
...
For regional gross bands, see the [Portugal rental yield guide](/guides/portugal-rental-yield-guide/). For foreign buyer purchase path, see [buy property Portugal foreigner](/guides/how-to-buy-property-portugal-step-by-step/).
...
AL diligence adds five checks to a standard purchase, and all of them run before the CPCV. Confirm the municipal containment position for the exact address, the RNAL registration and whose name it stands in, the condominium's position under DL 76/2024, the building's suitability, and whether the licence survives the sale at all.
...
Portuguese Estate is the editorial and advisory desk for portuguese-estate.com, focused on foreign buyers underwriting Portugal freehold with honest regulatory math. We do not sell municipal registrations; we stop clients signing CPCVs where the STR story contradicts RNAL and RMAL data.
...
Three buyer profiles meet the AL rules differently. An owner-occupier letting occasionally needs the registration but not the yield; an investor underwriting short-let income needs the licence to be obtainable rather than merely present today; and a buyer in a contained parish needs a long-term letting fallback that still works.
...
## Transferring an AL Licence When the Property Sells

An AL registration attaches to the operator and the property together, and what happens on a sale depends on where the property is and what the contract says.

| Situation | What happens to the registration |
|---|---|
| Sale in a municipality with no containment restriction | Transfer is possible where the framework and the contract provide for it |
| Sale inside a Lisbon containment zone | The registration is at risk on transfer, which is the point of containment |
| Sale where the buyer does not intend to operate | The registration lapses with the activity |
| Transfer agreed but not documented in the CPCV | The buyer inherits a dispute rather than a licence |

Decree-Law 76/2024 sets the framework for transfer on sale, and municipalities apply it against their own containment maps. The practical consequence is that an AL registration is a valuable part of the price in some places and worth nothing in others, and the difference is a map rather than a negotiation.

Two things belong in the promissory contract. First, an explicit clause on whether the registration transfers, on what condition, and what happens if the municipality refuses. Second, a price adjustment mechanism if the transfer fails, because a buyer paying a premium for a licence that then lapses has bought a different property from the one they agreed.

Verify the registration number and its current status before the CPCV, not after. A registration that is suspended, or attached to a different fiscal number from the seller you are dealing with, is a problem to discover at the diligence stage.

## Alojamento Local: city-by-city detail

| Topic | Guide |
|---|---|
| RNAL portal registration | [RNAL Registration Portugal](/guides/rnal-registration-portugal/) |
| Porto municipal AL rules | [Porto AL Licence Rules 2026](/guides/porto-alojamento-local-rules/) |
| Algarve Airbnb strategy | [Algarve Airbnb Investment Guide](/guides/algarve-airbnb-investment-guide/) |
| AL licence transfer on sale | AL Licence Transfer Portugal |
| Lisbon RMAL containment | [Lisbon AL Containment Zones](/guides/lisbon-alojamento-local-containment-zones/) |

## The full first-year cost of getting an AL running

Registration itself is free; getting to a legal first guest is not. Budget the mandatory liability insurance at €150 to €400 a year, compulsory on the portal since March 2025 under DL 76/2024. Add furnishing and equipping an empty two-bedroom to tourist accommodation standard at €12,000 to €20,000, the safety equipment the filing requires, and a condominium consent process that can take weeks where the building's rules are silent. Accountancy for a Category B operator runs €400 to €900 a year against €150 to €400 for a long-term tenancy. First-year cash outlay beyond the purchase therefore lands near €14,000 to €22,000 before a single night is sold. None of this is recoverable if the condominium later blocks short-term letting, which is why the condominium rules belong in due diligence rather than after furnishing.
