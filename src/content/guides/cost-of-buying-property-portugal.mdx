---
title: "Cost of Buying Property in Portugal: 2026 Cost Guide"
...
readingTime: 12
featured: true
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/cost-of-buying-property-portugal/hero"
heroImageAlt: "The top of Lisbon Santa Justa Lift"
heroImageCredit: "Pedro Ribeiro Simões from Lisboa, Portugal / Wikimedia Commons"
heroImageLicence: "CC BY 2.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:The_top_of_Lisbon_Santa_Justa_Lift_(26463851550).jpg"
heroImageWidth: 1280
heroImageHeight: 915
faq:
  ...
  - question: "Are there any hidden costs when buying Portuguese property?"
    answer: "Watch for energia certificate €300-500, surveyor €800-1,500, translation fees €200-800, and potential capital gains tax on exit (50% of the net gain at 14.5-48% IRS rates)."
...
<TldrBlock text="Budget 6–11% on top of the purchase price for a typical residential deal: IMT (7.5% flat for non-residents from 1 Sep 2026), stamp duty 0.8%, legal and notary fees, plus registration. Annual IMI runs 0.3–0.45% of fiscal value." />
...
Buying costs in Portugal run to roughly 10% of the purchase price for a non-resident, and IMT is the largest single line. From 1 September 2026 under DL 97/2026 non-residents pay a flat 7.5% of the acquisition value, replacing the progressive bands that applied before.
...
Annual holding costs start with IMI, charged on the rateable value at 0.3% to 0.45% for urban property, 0.8% for rustic and 1.3% for commercial. Condominium quotas, insurance, maintenance and AIMI above EUR 600,000 of taxable value complete the recurring picture.
...
<InlineCta
  ...
  ctaId="guide_mid_cost_of_buying_property_portugal"
...
A Portuguese mortgage adds its own layer of fees on top of the purchase costs: an arrangement fee of 0.5% to 1% of the loan, a valuation at EUR 300 to EUR 800, credit assessment and the bank's legal charges. Non-resident lending typically caps at 70% to 80% loan to value.
...
Acquisition costs are national in percentage terms and regional in absolute ones, because the price they apply to varies. On a EUR 500,000 Lisbon apartment a non-resident pays EUR 37,500 IMT and EUR 4,000 stamp duty, which with professional fees totals roughly 9.8% of price.
...
Exit costs belong in the purchase model rather than being deferred to the sale. Half the net gain enters the IRS return at the progressive 14.5% to 48% scale for non-residents, agency commission runs around 5% plus 23% IVA, and neither is recoverable.

### Sale Costs for Non-Residents

Capital Gains Tax: 50% of the net gain at 14.5–48% IRS rates
...
Taxable gain: €50,000
CGT due: €9,250 (50% inclusion at a 37% marginal rate)
```
...
One legitimate route reduces the largest line. A non-resident who becomes Portuguese tax resident within 24 months of the purchase can reclaim the difference between the flat 7.5% paid and the progressive resident bands, which requires 183 days of presence and formal registration.
...
The costs that break budgets are the ones due diligence uncovers rather than the ones the calculator lists. Structural problems, legal complications and title defects each carry four to five figure ranges, and a contingency of 5% to 10% above the modelled total is the working assumption.
...
## What the September 2026 deadline changed

What shifted, and what did not:
The September 2026 IMT reform changes the shape of the charge, not only its level: a flat 7.5% on the whole price replaces a progressive scale that taxed slices. The direction of the effect is easy to state and the size is not, because it depends entirely on price. The comparison that matters is the one your lawyer runs in the AT simulator on your own figure, against the pre-reform scale, and the tables above give both bases for that.
...
## What does the 2025 data say about buying costs?

The public figures explain why acquisition cost now matters more than it did three years ago. INE recorded 169,812 transactions in 2025 with the price index up 17.6%, so the same percentage charge applies to a larger base, and the non-resident IMT reform then raised that percentage on top.

Full 2025 series: [the record year](/guides/portugal-property-market-record-2025-ine-data/).

Two INE datasets should be kept separate when reading any commentary on this. Non-resident purchases, meaning buyers with tax domicile abroad, totalled 8,471 in 2025 and fell 13.3%. Purchases by foreign-born buyers who are Portuguese tax residents are counted differently, and Brazilian-born buyers led that group at 9,808 purchases. The two numbers describe different people and different tax positions, and conflating them produces wrong conclusions about demand.

Before you sign a CPCV, confirm the registered charge search at the registo predial, the licença de utilização for the exact fraction, a [condominium debt certificate](/guides/condominium-fees-portugal/), and whether any existing AL licence transfers. These checks sit outside the purchase price and prevent five-figure surprises after the escritura.
...
Annual carry begins the day after completion and is the half of the cost picture most budgets omit: IMI at 0.3% to 0.45% of the VPT, condominium charges, insurance, and a fiscal representative at €150 to €500 a year for non-EU owners. On a €400,000 apartment that stack runs €2,000 to €3,500 before any maintenance.

Where the buyer intends to become Portuguese tax resident within 24 months, the 7.5% IMT becomes a refundable deposit rather than a cost, which changes the cash-to-close calculation materially. Model both versions before deciding how much to borrow.

Cash buyers should open the Portuguese account and clear source-of-funds checks before agreeing a completion date. Anti-money-laundering review on an inbound foreign transfer routinely adds two to four weeks, and the delay counts against the CPCV deadline rather than against the bank.

## Related guides on Portuguese Estate

Acquisition cost is one of four numbers a buyer needs, and the other three sit in separate guides: the annual IMI and AIMI charge, the letting tax position if the property will earn, and the exit cost when it sells. Model all four before committing to a price.
...
Buying costs go wrong in predictable places, and each one is checkable before the promissory contract. An IMT figure quoted on the old progressive bands rather than the flat 7.5%, a VPT nobody obtained, and a budget with no contingency for what diligence finds are the three that recur.
...
For the full purchase sequence including timing of these costs, see [buy property as a foreigner](/guides/how-to-buy-property-portugal-step-by-step/).
...
| Capital gains on sale | 50% of gain taxed at scale | 50% of gain taxed at scale | Variable |
...
Insider tip: non-resident buyers completing after 1 September 2026 should lock IMT assumptions at CPCV stage using your lawyer's AT simulation, do not rely on portal calculators alone if property use (primary vs secondary) or corporate ownership is in play.

## The Costs Buyers Do Not Budget For

The headline items, IMT and stamp duty, are easy to find. These are the ones that appear after the offer is accepted.

| Item | Why it is missed | When it lands |
|---|---|---|
| Fiscal representative | Required for non-EU and non-EEA residents, charged annually | From ownership, every year |
| Energy certificate | The seller commissions it, but a missing one delays the deed | Before marketing or completion |
| Structural survey | Optional in Portugal, which is why buyers skip it | Before the CPCV, if at all |
| Bank account setup and running costs | Account maintenance and transfer charges | From opening |
| Document translation and legalisation | Foreign documents need certified translation, sometimes an apostille | During the application chain |
| Currency spread | The gap between the interbank rate and what you are quoted | At every transfer |

The fiscal representative is the one that recurs. It is not a one-off fee at purchase, it is an annual charge for as long as you own the property while resident outside the EU or EEA. Over a ten-year hold it is a meaningful number, and almost no closing-cost calculator includes it. See [fiscal representative in Portugal](/guides/fiscal-representative-portugal/).

The survey is the one worth reversing. Portugal has no equivalent of the British homebuyer survey convention, so most purchases proceed without one. On older stock, particularly anything with a renovation history or coastal exposure, the cost of a survey is a rounding error against what it can find.
