---
title: "Buying Property in Portugal on a D8 Visa: 2026 Guide"
description: "What buying a home looks like on a Portugal D8 visa: tax residency timing, the flat 7.5% non-resident IMT, and Lisbon, Porto and Algarve scenarios."
pubDate: 2026-06-17
...
segment: invest
featured: true
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/portugal-digital-nomad-visa-property/hero"
heroImageAlt: "Praia da Bela Vista - Costa da Caparica - Portugal — Lisbon creative quarter — the D8 digital nomad visa"
heroImageCredit: "Vitor Oliveira from Torres Vedras, PORTUGAL / Wikimedia Commons"
heroImageLicence: "CC BY-SA 2.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Praia_da_Bela_Vista_-_Costa_da_Caparica_-_Portugal_(8445354160).jpg"
heroImageWidth: 1280
heroImageHeight: 853
faq:
  ...
  - question: "What is the minimum income for Portugal D8 visa in 2026?"
    answer: "Consular practice in 2026 typically requires proof of stable remote income at roughly four times the Portuguese minimum wage, about €3,680 per month for the main applicant. Dependents add lower proportional thresholds. Income must come from employment or self-employment outside Portugal. Savings alone rarely substitute unless your consulate explicitly accepts a combined package."
...
Quick Answer: Portugal's D8 visa lets remote workers with stable foreign income of about €3,680 per month obtain a one-year residence path renewable while living in Portugal. You can buy property on D8 under the same rules as any foreign buyer; ownership does not qualify the visa. Tax residency triggered by long stays applies worldwide income rules, and NHR is closed to new applicants. Compare D8 against D7, Schengen tourism, and Golden Visa funds before linking your home purchase to immigration strategy.

<TldrBlock text="D8 = remote work visa, ~€3,680/month income (2026), 1-year permit renewable. Property purchase allowed; does not qualify visa. Same CPCV/escritura as foreigners. Tax: 183+ days or habitual abode → resident; NHR closed end-2024. vs D7 (passive ~€920/mo), vs tourist 90/180 Schengen, vs GV €500k fund (no direct RE). Lisbon connectivity + AL containment; Porto yield; Algarve lifestyle + STR. Remote buy via procuração. Side AL: verify RNAL before CPCV." />

For the visa itself, the EUR 3,680 income test and the difference between the two D8 variants, start with [the Portugal D8 digital nomad visa guide](/move-to-portugal/d8-digital-nomad-visa/). This page picks up at the purchase decision.
...
Consular guidance for D8 applications in 2026 centres on proving stable remote income at approximately four times the Portuguese minimum wage, which translates to about €3,680 per month for the principal applicant in current practice. This figure moves when the national minimum wage is updated; always confirm the live threshold with your consulate before budgeting a move.
...
<InlineCta
  ...
  ctaId="guide_mid_portugal_digital_nomad_visa_property"
...
|---|---|---|---|---|
| Core income test | Remote work ~€3,680/mo | Passive ~€920/mo | None (tourism) | ~€500,000 fund investment |
...
D8 income thresholds are expressed as multiples of the national minimum wage, so they move whenever the minimum wage does; the figures here follow the official multiple and the consulate circulars rather than agent marketing sheets. Consulate decision outcomes are not published centrally at all, which is worth knowing before reading any success-rate claim about this visa, including one framed as experience.
