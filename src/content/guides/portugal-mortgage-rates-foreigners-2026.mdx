---
title: "Portugal Mortgage Rates for Foreigners: 2026 Guide"
...
readingTime: 17
featured: false
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/portugal-mortgage-rates-foreigners-2026/hero"
heroImageAlt: "The Clérigos tower seen from the Jardim da Cordoaria, Porto"
heroImageCredit: "Reiner Ehlers / Wikimedia Commons"
heroImageLicence: "CC BY 2.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Windy_day_at_the_beach_in_Portugal_near_Porto_(53206994266).jpg"
heroImageWidth: 1280
heroImageHeight: 960
relatedSlugs:
...
Portuguese banks lend to non-residents routinely, but on tighter terms than they offer residents, and the tightening is mostly in the loan-to-value ratio rather than the rate.

| Borrower | Typical maximum LTV | What the bank looks at hardest |
|---|---|---|
| Portuguese tax resident | Highest of the three | Local income and Portuguese credit history |
| EU or EEA resident non-resident buyer | Middle band | Documented income, existing debt, source of funds |
| Non-EU resident buyer | Lowest band | Source of funds, country risk, transfer route |

Three consequences follow. The cash gap is larger than buyers expect, because the bank lends against the lower of purchase price and its own valuation, not against the price you agreed. Debt-to-income is assessed on your worldwide commitments, including a mortgage at home. And the file is document-heavy: income evidence, tax returns, bank statements, proof of the deposit source, and for non-EU buyers an explanation of the transfer route.

Work the deposit backwards from the valuation rather than the price. If the bank values a EUR 400,000 purchase at EUR 380,000 and lends at the non-resident band, the cash you need is the difference plus the acquisition costs, not the headline deposit percentage.

## Broker or Direct to the Bank

A broker and a direct application reach the same lenders and produce different outcomes for a non-resident. A broker knows which banks currently accept your nationality, income type and residence status, which matters when several decline foreign applicants outright; a direct application avoids the fee and takes longer.

Both routes work, and the honest answer depends on how ordinary your file is.

| Route | Earns its place when | Costs you |
|---|---|---|
| Direct to a bank | Your income is salaried, documented and in euros, and you have time to compare | Your own time approaching several banks separately |
| Through a broker | The file is unusual: self-employed, multiple currencies, non-EU residence, or a tight deadline | A fee, sometimes charged to you and sometimes paid by the lender |

Ask any broker two questions in writing: who pays them, and which lenders they do not have access to. A broker paid by the lender is not neutral, and one that covers four banks out of eight is not comparing the market.

The insurance bundle is where the quoted rate stops being the price. Portuguese mortgages are commonly offered with life and buildings cover attached, and the discount for taking the bank's policy is real but so is the premium. Ask for the rate with and without the bundle, and price the same cover independently before you accept the tied version.
...
## Fix the rate question before the property question

Portuguese Estate is the editorial and advisory desk for portuguese-estate.com. We do not originate loans or give regulated mortgage advice. We help foreign buyers avoid signing property contracts that depend on unrealistic LTV, rate, or timing assumptions.
