...
readingTime: 15
featured: true
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/prenuptial-agreement-portugal-property/hero"
heroImageAlt: "Quinta Senhora da Oliveira near Torres Vedras"
heroImageCredit: "Edna Winti / Wikimedia Commons"
heroImageLicence: "CC BY 2.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Agapanthus_in_Garden_at_Sintra(14654782894).jpg"
heroImageWidth: 1280
heroImageHeight: 960
relatedSlugs:
...
Portuguese law recognises three marital property regimes: comunhão de adquiridos, the default, under which assets acquired during marriage are shared; comunhão geral, under which almost everything is; and separação de bens, under which nothing is. Foreign couples do not fall into one automatically, and the notary will ask which applies.
...
Red flag: the delay that stops a married couple's completion is almost never a court dispute over the regime. It is a missing apostille or a late sworn translation. A marriage certificate sent to the lawyer after the CPCV deposit has already been paid is the standard version of this: the notary then wants a fresher certificate, an apostille, or a sworn translation, and none of those can be produced in the days a deed date leaves. Build a document calendar at the start.

## What should married buyers decide before signing CPCV?

The CPCV fixes price, deposit and completion date, and for a married couple it also fixes who is buying. Named parties, ownership shares and the applicable marriage regime all carry through to the escritura, and correcting them afterwards means a fresh deed rather than an amendment.
...
One document file settles the marital position before the CPCV rather than at the notary's desk. Marriage certificate, any prenuptial or postnuptial agreement, evidence of the governing law of the marriage, and a written instruction on intended ownership shares are the four items a Portuguese lawyer needs.
...
Use this guide with [CPCV promissory contract in Portugal](/guides/cpcv-promissory-contract-portugal/), [buy property in Portugal as a foreigner](/guides/how-to-buy-property-portugal-step-by-step/), [Portugal property due diligence](/guides/due-diligence-portugal-property/), and [power of attorney for Portugal property](/guides/power-of-attorney-property-portugal/) before signing.

## How the marriage regime changes who owns the property

The regime chosen at marriage decides ownership of a Portuguese purchase, and it is recorded on the escritura. Under comunhão de adquiridos, the default, property acquired during the marriage is jointly owned regardless of who paid. Under separação de bens, each spouse owns what they buy. Under comunhão geral, effectively everything is shared. The choice also drives AIMI: joint ownership shares a €1.2 million allowance against €600,000 for a single owner, which on a €1.5 million holding is worth several thousand euros a year. Foreign couples should confirm how their home-country regime is recognised in Portugal before escritura, because restructuring afterwards triggers a fresh IMT charge. Record the chosen regime on the escritura itself rather than relying on a foreign marriage certificate to establish it later.
