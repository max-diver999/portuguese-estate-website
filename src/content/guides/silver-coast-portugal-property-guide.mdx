---
title: "Silver Coast Property Market 2026: Prices and Yields"
...
readingTime: 18
segment: invest
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/silver-coast-portugal-property-guide/hero"
heroImageAlt: "The bay at São Martinho do Porto — the Silver Coast property guide"
heroImageCredit: "José Martinho / Wikimedia Commons"
heroImageLicence: "CC0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:A_Golden_Beach_(131401413).jpeg"
heroImageWidth: 1280
heroImageHeight: 826
faq:
...
For where to buy in the Silver Coast town by town, with buying and holding costs, start with [property for sale in the Silver Coast](/property-for-sale/silver-coast/). This page is the market data behind that decision.
...
The Silver Coast trades a lower entry price for a shorter season and a longer sale. Peniche, Nazaré and the Óbidos corridor sit within roughly an hour of Lisbon, which supports weekend demand that pure holiday markets lack, but winter occupancy falls sharply and resale timelines run longer than in the capital. Underwrite it as a lifestyle asset with rental support, rather than as a yield play with a view.

For yield methodology after choosing a town, cross-read the [Portugal rental yield guide](/guides/portugal-rental-yield-guide/) and [gross vs net yield Portugal](/guides/portugal-rental-yield-guide/). For a ranked comparison across all major regions, see [best regions to invest in Portugal property 2026](/guides/best-regions-invest-portugal-property-2026/).
...
<InlineCta
  ...
  ctaId="guide_mid_silver_coast_portugal_property_guide"
...
| Yield maths | [Gross vs Net Yield Portugal](/guides/portugal-rental-yield-guide/) |
| Foreign buyer path | [Buy Property Portugal Foreigner](/guides/how-to-buy-property-portugal-step-by-step/) |
...
| Caldas da Rainha yield hub | [Caldas da Rainha Property Investment](/property-for-sale/silver-coast/) |
| Ericeira surf & nomads | [Ericeira Property Investment](/areas/ericeira-property-investment/) |
| Lourinhã west value coast | [Lourinhã Property Investment](/property-for-sale/silver-coast/) |
| German buyer segment | [German Buyers Portugal Property](/move-to-portugal/by-nationality/) |
...
## What the Silver Coast offers against the Algarve

The Silver Coast trades season length for entry price. Towns from Nazaré and São Martinho do Porto through Caldas da Rainha and Lourinhã price between roughly €2,400 and €3,800 per square metre, against €3,200 to €4,700 across most of the Algarve. On a 90 square metre two-bedroom that is a difference of €70,000 to €90,000 on the same unit size. Gross yields of 4% to 5.5% sit slightly below Algarve short-let potential but rest on a longer, steadier letting season and less exposure to the four-month revenue concentration that defines Algarve underwriting. Lisbon is 60 to 90 minutes away, which supports weekend demand the deeper Alentejo cannot. Verify winter letting demand for the specific town, because the coastal strip varies sharply between year-round centres and purely seasonal villages.
