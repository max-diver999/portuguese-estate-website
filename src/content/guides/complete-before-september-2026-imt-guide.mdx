...
readingTime: 16
featured: true
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/portugal/guides/complete-before-september-2026-imt-guide/hero.webp"
...
heroImageSource: "https://commons.wikimedia.org/wiki/File:Portugal_Coast_(48415017011).jpg"
heroImageWidth: 1280
heroImageHeight: 853
faq:
...
<TldrBlock text="The September 2026 IMT deadline matters most for non-residents buying €250k-€600k property who will not become Portuguese tax resident soon. Complete early only if due diligence, financing, source-of-funds checks and escritura booking can all finish safely before 1 September 2026." />
...
Insider tip: an early-completion file should be boring. They are registered resales with one seller, no mortgage discharge complexity, no pending works, no AL transfer dependency and a lawyer who has reviewed the pack before the CPCV deposit is wired. Boring is good when the calendar is tight.

## How much can early completion save?

The saving is the difference between the old progressive IMT estimate and the flat 7.5% non-resident rate. It varies by price, property use and official calculation method. The table below gives commercial planning ranges and does not replace your lawyer's AT simulation.
...
The [CPCV promissory contract Portugal](/guides/cpcv-promissory-contract-portugal/) guide explains deposit protection and suspensive clauses. In a deadline-driven deal, those clauses matter more than usual because the timetable leaves little room for error.
...
Do not rush when the property file is unclear, the seller cannot prove authority, financing is not final, the buyer does not understand the CPCV, or the property's rental thesis depends on licences that have not been verified. Tax urgency does not cure legal defects, and a rushed deed leaves those defects with you after completion.
...
For risk controls beyond the deadline, read [hidden costs buying property Portugal](/guides/cost-of-buying-property-portugal/) and [stamp duty Portugal property](/guides/stamp-duty-portugal-property/). Stamp duty is unchanged by the September deadline, but it still must be paid before the deed.

## How does the IMT refund pathway change the urgency?

If you genuinely plan to become Portuguese tax resident within the qualifying window, the deadline may be less important because you may recover the IMT difference later. The refund path, however, depends on facts and documents that prove the plan, and casual intent will not be enough.
...
The refund guide explains evidence requirements and timing: [IMT refund for tax resident buyers](/guides/imt-refund-tax-resident-portugal/). If your refund plan fails, the 7.5% IMT becomes a permanent acquisition cost.

## What if completion slips into September despite the CPCV?

If completion slips, the outcome depends on why it slipped and what the CPCV says. Seller-caused delay, buyer-caused delay, bank delay and neutral administrative delay can lead to different remedies, which is why deadline allocation must be written into the CPCV.
...
The tax authority will not usually care why the deed happened in September. It applies the law at the relevant taxable event. Your commercial remedy lies against the seller or under the CPCV; asking the tax office to honour an August intention will not work.
...
Insider tip: when a deadline distorts a market, the best advice is often to slow down for 24 hours and calculate. If early completion saves €8,000 but the property has €15,000 of unresolved condominium works, the deadline is noise. If it saves €12,000 on a clean file and the seller will sign strong clauses, the deadline is an opportunity.

## Related guides for deadline-driven buyers

A buyer racing the 1 September 2026 IMT change needs three things settled fast: what the new flat 7.5% actually costs on their price, whether the 24-month residency refund route applies to them, and how long the purchase mechanics realistically take from offer to deed.
...
- [Hidden costs buying property Portugal](/guides/cost-of-buying-property-portugal/)

## What completing before September 2026 is actually worth

The saving depends entirely on price, and it is smaller at the top than most buyers assume. On a €300,000 purchase the resident progressive schedule produces roughly €11,000 of IMT against €22,500 at the flat 7.5% rate, a gap near €11,500. On a €900,000 purchase the progressive schedule already reaches into its highest band, so the gap narrows sharply. Set that saving against the cost of rushing: a compressed due diligence window, a deposit committed before the land registry search returns, and a longstop date you did not negotiate. Below roughly €500,000 the arithmetic usually favours completing early; above it, the saving rarely justifies shortening due diligence. Whatever you decide, write the outcome into the CPCV: name which party absorbs the difference if completion slips past the deadline.
