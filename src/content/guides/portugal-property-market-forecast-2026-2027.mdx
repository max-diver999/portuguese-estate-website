...
readingTime: 18
segment: invest
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/portugal-property-market-forecast-2026-2027/hero"
heroImageAlt: "Modern apartment blocks in Lisbon"
heroImageCredit: "Donald Judge from England / Wikimedia Commons"
heroImageLicence: "CC BY 2.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:24.4.14_Modern_Lisbon_46_(14035265323).jpg"
heroImageWidth: 1280
heroImageHeight: 851
faq:
...
If you need the strategic hub for regional routing, yields and red flags, start with the [Portugal property investment guide](/guides/portugal-property-investment-guide/). If you are deciding whether the asset class still fits your return hurdle, cross-read [is Portugal property a good investment in 2026](/guides/portugal-property-investment-guide/). For tax timing that directly shifts our Q3 2026 volume forecast, see [IMT tax for non-residents](/guides/imt-tax-non-resident-portugal-2026/).
...
| National price index (INE) | base | +17.6% YoY | n/a |
| Non-resident purchases | 9,771 | 8,471 | -13.3% |
| New dwelling licences | 34,625 | 41,592 | +20.1% |
| Non-resident avg. price (national) | n/a | €470,277 | n/a |
...
For the honest asset-class verdict independent of forecast timing, read [is Portugal property a good investment in 2026](/guides/portugal-property-investment-guide/), it separates residency goals from rental yield under the new tax regime.
...
<InlineCta
  ...
  ctaId="guide_mid_portugal_property_market_forecast_2026_2027"
...
| Licence growth rate | n/a | +20.1% | Supply response accelerating |
...
For implementation, regional routing, yield maths, CPCV mechanics and scam avoidance, continue to the [Portugal property investment guide](/guides/portugal-property-investment-guide/). For the direct "should I buy?" answer against 2026 conditions, read [is Portugal property a good investment in 2026](/guides/portugal-property-investment-guide/). For acquisition tax timing that can shift your personal outcome between scenarios, study [IMT for non-residents](/guides/imt-tax-non-resident-portugal-2026/).

## What the current data supports as a forecast

Any 2026 to 2027 forecast has to reconcile three figures from 2025: prices up 17.6%, 169,812 transactions worth €41.2 billion, and 41,592 new dwelling licences, a 20.1% increase (INE, AICCOPN). Supply responding at 20% while non-resident purchases fell 13.3% to 8,471 points toward moderation rather than continuation. Licences precede completions by two to three years, so the new stock lands in 2027 and 2028, precisely the window most buyers are underwriting. The defensible base case is continued but slowing nominal growth, with the sharpest moderation in Lisbon fringe, Porto suburbs and Algarve resort belts where new product concentrates. Treat any projection extrapolating 17.6% annual growth as a sales argument rather than a forecast. Underwrite on rental income you can evidence today rather than on appreciation, and treat further capital growth as upside.
