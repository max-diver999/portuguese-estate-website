...
This is not overkill. It is how you avoid buying a property that works only in a sales brochure. For purchase process detail, see the [Portugal buy-to-let investment guide](/guides/portugal-property-investment-guide/) and the [gross vs net yield guide](/guides/portugal-rental-yield-guide/).
...
Use this guide alongside [Portugal buy-to-let investment](/guides/portugal-property-investment-guide/), [gross vs net yield](/guides/portugal-rental-yield-guide/), [Alojamento Local licensing](/guides/alojamento-local-license-portugal/), [Portugal capital gains tax](/guides/portugal-capital-gains-tax-property/), and the [Portugal rental yield guide](/guides/portugal-rental-yield-guide/) before committing to a rental-led purchase.
