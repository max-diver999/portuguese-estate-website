...
readingTime: 15
featured: true
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/non-resident-rental-income-tax-portugal/hero"
heroImageAlt: "Rua das Flores in central Porto — non-resident rental income tax"
heroImageCredit: "Ana Rey from Sevilla, España / Wikimedia Commons"
heroImageLicence: "CC BY-SA 2.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Camino_a_Praia_do_Vale_Espinha%C3%A7o_Ruta_dos_Sete_Vales_Suspensos_(50601637912).jpg"
heroImageWidth: 1280
heroImageHeight: 856
relatedSlugs:
...
<TldrBlock text="A non-resident landlord should not underwrite Portugal yield from gross rent. Model 28% tax on the relevant taxable base, IMI, management, condominium fees, maintenance, vacancy, accountant costs, and any home-country reporting. Simplified tax often works for clean long-term lets; actual expenses can win when management, interest, and repairs are heavy." />
...
Insider tip: a long-term apartment bought with cash usually stays better off in the simplified regime, because the flat deduction beats the deductions an unleveraged property can actually produce. The calculation flips when condominium charges or a repair year are unusually high, or when there is mortgage interest to deduct — so it is worth rerunning in any year the costs change, not deciding once. Furnished AL assets and mortgaged properties deserve an annual comparison. The decision should be made each tax year using actual invoices, not at purchase based on agent projections.
...
## What 28% actually leaves on a Porto letting

Non-resident rental income is taxed at a flat 28% in Portugal, and the base is net of documented expenses rather than gross rent. A €340,000 Porto apartment letting at €1,400 a month grosses €16,800. Deduct IMI of about €952, condominium charges of €1,200, management at 10% (€1,680) and a maintenance reserve at 6% (€1,008) and the taxable base falls to €11,960. Tax at 28% is €3,349, leaving €8,611 net. Against total capital deployed of €376,720 once acquisition costs are counted, that is 2.29% after tax. Keeping invoices is worth roughly €1,350 a year here — the difference between taxing gross rent and taxing the net figure the law actually allows. Register the lease with Finanças and issue electronic receipts: without them the deductions above cannot be claimed at all.
