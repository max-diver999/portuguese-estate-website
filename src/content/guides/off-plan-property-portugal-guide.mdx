...
featured: true
segment: invest
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/off-plan-property-portugal-guide/hero"
heroImageAlt: "Castelo de São Jorge, Lisboa"
heroImageCredit: "Vitor Oliveira from Torres Vedras, PORTUGAL / Wikimedia Commons"
heroImageLicence: "CC BY-SA 2.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Castelo_de_S%C3%A3o_Jorge_-_Lisboa_-_Portugal_(31891063787).jpg"
heroImageWidth: 1280
heroImageHeight: 842
relatedSlugs:
...
<TldrBlock text="Off-plan = buy before completion with staged CPCV payments. Decreto-Lei 67/2003 mandates bank guarantee on all pre-deed sums. Check alvará de construção, AICCOPN pipeline context, and a hard longstop date. Deposits 15-30% then milestone tranches. IMT 7.5% + stamp 0.8% for non-residents at escritura (from Sep 2026). Lisbon/Porto/Algarve lead supply. Use your own lawyer; never skip guarantee verification." />
...
<InlineCta
  ...
  ctaId="guide_mid_off_plan_property_portugal_guide"
...
Off-plan payments arrive in stages rather than as the single 10% to 30% deposit a resale purchase uses, and every stage before the deed must be covered by a DL 67/2003 bank guarantee. That guarantee, not the developer's reputation, is what protects money paid years ahead of completion.
...
Off-plan diligence is permit and guarantee diligence, and it happens before the reservation fee rather than before the deed. The alvará, the IMPIC registration, the DL 67/2003 guarantee naming you, the land registry match and the longstop date with its remedy are the five critical items.
...
Off-plan suits a narrow set of buyers: those with a horizon long enough to absorb delay, no immediate housing need, and a tolerance for construction risk that a completed property does not carry.
...
An off-plan escritura carries checks a resale deed does not, and they run in the days before signing. Confirm the licença de utilização has issued, the built unit matches the contracted plans and areas, snagging is documented, and the bank guarantee is released only on completion rather than earlier.
...
## What protects an off-plan deposit, and what does not

Decreto-Lei 67/2003 is the provision that matters: any sum paid before the licença de utilização exists must be covered by a bank guarantee or insurance policy equal to the cumulative amount paid. On a €450,000 off-plan purchase with a 30% staged deposit, that is €135,000 of exposure that the guarantee, not the developer's reputation, secures. Two checks follow. The guarantee certificate must name the exact seller entity on the CPCV, not the marketing brand on the hoarding. And it must be reissued as each tranche is paid, because cover written for the first payment does not extend to the third. A longstop date with refund mechanics completes the protection. Have your own lawyer read the guarantee, not the developer's: cover is worthless if it names the wrong entity or the wrong sum.
