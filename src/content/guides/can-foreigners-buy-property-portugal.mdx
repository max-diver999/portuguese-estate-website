...
readingTime: 19
featured: false
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/can-foreigners-buy-property-portugal/hero"
heroImageAlt: "Houses in Porto"
heroImageCredit: "Henning Supertramp from Germany / Wikimedia Commons"
heroImageLicence: "CC BY 2.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Houses_in_Porto_(38089511162).jpg"
heroImageWidth: 1280
heroImageHeight: 960
relatedSlugs:
...
Americans, British and Brazilian nationals all buy Portuguese property freely with full freehold title, registered at the Conservatória do Registo Predial on identical terms to a Portuguese citizen. No minimum investment applies to ownership itself; only the Golden Visa route ever carried thresholds, and it closed to property in October 2023.
...
Ownership rights are identical for EU and non-EU buyers, and the administrative experience differs in three places: a non-EU buyer needs a fiscal representative in Portugal, faces flat 7.5% IMT rather than resident bands unless they relocate, and requires a visa to stay beyond 90 days in any 180.
...
<InlineCta
  ...
  ctaId="guide_mid_can_foreigners_buy_property_portugal"
...
Brazilian volume reflects linguistic ties, Lusophone legal familiarity, and a large resident diaspora, not only holiday-home non-residents. Angolan buyers cluster in greater Lisbon premium suburbs. French interest remains strong on the Silver Coast and Alentejo where entry prices sit well below comparable Atlantic France. Nationality-specific playbooks: [Brazilian buyers](/move-to-portugal/by-nationality/), [Angolan buyers](/move-to-portugal/by-nationality/), and [French buyers](/move-to-portugal/by-nationality/). Every foreign buyer still needs a [NIF before the CPCV](/guides/nif-portugal-property-purchase/).

## The Golden Visa Real Estate Route: Closed Since October 2023

Two separate things are routinely confused here, and the distinction decides whether a purchase makes sense. Buying property in Portugal is open to any nationality and always has been. Buying property as a route to Portuguese residency ended on 7 October 2023 under Law 56/2023.
...
A foreign owner acquires the same rights as a Portuguese citizen once the escritura is signed and registered at the Conservatória do Registo Predial. Freehold title, the right to sell, let, mortgage, renovate subject to licensing, and bequeath the property all apply without any nationality qualification.
...
Portugal is among the more open European markets for foreign ownership: no nationality restriction, no approval requirement, and a registry system that records title clearly. What it charges instead is a flat 7.5% IMT for non-residents from 1 September 2026, plus fiscal representation and remote administration.
...
Portuguese title problems are documentary rather than hidden, which means diligence finds them and a rushed purchase does not. Unregistered extensions, a licença de utilização that does not match the building, undivided inheritance among heirs, and charges on the registry account for most of what goes wrong.
...
Every foreign buyer needs the same core pack regardless of nationality: a NIF, identification, proof of funds for anti-money-laundering checks, and a Portuguese bank account or lawyer's client account. Non-EU buyers add fiscal representation, and remote buyers add a notarised power of attorney.
...
For the full step-by-step process, including CPCV negotiation, IMT payment, and escritura signing, see our comprehensive [guide to buying property in Portugal as a foreigner](/guides/how-to-buy-property-portugal-step-by-step/).

## Ownership Structures: Personal vs Corporate

Corporate ownership changes the tax treatment rather than the right to buy. A Portuguese company is charged IMT at resident rates rather than the flat 7.5%, pays IRC on gains instead of IRS, and carries annual accounting and filing costs that rarely justify themselves on a single home.
...
| Capital gains on sale | 50% of gain at 14.5–48% IRS | 21% IRC on full gain |
...
For the full buying process, see our step-by-step [guide to buying property in Portugal as a foreigner](/guides/how-to-buy-property-portugal-step-by-step/).
...
## What foreign buyers can and cannot do, in numbers

Portugal places no restriction on foreign ownership: no reciprocity test, no quota, no permit, and freehold title is available to any nationality. INE recorded 8,471 non-resident purchases in 2025, down 13.3% year on year, within a national market of 169,812 transactions. What differs is not the right to buy but the cost of buying: non-residents pay flat 7.5% IMT from September 2026 rather than the resident schedule, need a NIF, and if resident outside the EU or EEA must appoint a fiscal representative at €150 to €500 a year. Ownership rights are identical; the administrative path and the tax bill are not. The one genuine restriction is on agricultural land above certain sizes, which follows land-use rules rather than nationality and rarely affects residential buyers.
