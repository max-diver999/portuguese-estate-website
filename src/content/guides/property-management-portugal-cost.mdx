---
title: "Portugal Property Running Costs 2026: Fees and Upkeep"
description: "Portugal managers charge 8-12% long-term and 18-25% for AL in 2026. With cleaning, platform fees and maintenance reserve, all-in costs reach 35-45% of gross."
pubDate: 2026-06-17
...
readingTime: 22
featured: true
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/property-management-portugal-cost/hero"
heroImageAlt: "An apartment building in Loulé, Algarve — property management costs"
heroImageCredit: "SUITE ON 7TH / Wikimedia Commons"
heroImageLicence: "CC BY-SA 4.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:EDIF%C3%8DCIO_LOUL%C3%89.jpg"
heroImageWidth: 1280
heroImageHeight: 853
faq:
...
Quick Answer: Long-term letting management in Portugal costs 8-12% of monthly rent in 2026. Short-term AL management costs 18-25% of gross bookings. Add cleaning at €50-120 per turnover, platform commissions of 3-15%, RNAL insurance from €150 a year, a maintenance reserve of 1-2% of property value, and IMI, and total all-in costs for professionally managed AL reach 35-45% of gross before tax. Long-term overhead stays lower at 20-28% of gross annual rent.

<TldrBlock text="Long-term management runs 8-12% of rent plus maintenance and IMI, totalling 20-28% of gross. Short-term AL management runs 18-25% plus cleaning, platform fees, insurance, and RNAL compliance, totalling 35-45% of gross before tax. The cost gap between strategies is real and must be modelled before choosing a rental approach." />
...
## What do long-term letting agents charge in Portugal?

Long-term arrendamento management in Portugal is typically structured as a recurring monthly percentage of 8-12%, occasionally supplemented by a one-off tenant-finding fee of one month's rent. On a Lisbon flat let at €1,550 per month, that is €124 to €186 monthly plus a finder fee in the first year.
...
Before IMI, [condominium fees](/guides/condominium-fees-portugal/), maintenance reserves, and tax, more than half of gross income is consumed by management and operational costs. This is not unusual in well-run AL operations with professional management; it is the baseline, not the exception. Passive investors comparing AL and long-term should model from this baseline rather than headline management percentages.
...
## How much does RNAL compliance and insurance cost?

RNAL registration and ongoing compliance is a mandatory cost category for any AL operation in Portugal. Filing itself is free nationally, but professional setup including municipal charges and habitability review typically runs €800 to €2,500, and civil-liability insurance has been compulsory since March 2025 at €150 to €400 per year.
...
<InlineCta
  ...
  ctaId="guide_mid_property_management_portugal_cost"
...
Alojamento Local units must be furnished and equipped to tourist accommodation standards before the first guest, which makes furnishing a non-negotiable capital cost rather than an optional upgrade. For a two-bedroom apartment budget a one-off €12,000 to €20,000 covering beds, seating, appliances, kitchenware, linen sets and the safety equipment the portal filing requires. A long-term tenancy can be handed over unfurnished at no equivalent cost.
...
Cleaning is the most frequently underestimated line in AL management, and it sits outside the management percentage — it is billed per turnover directly to the owner. At €45 to €70 per changeover, a unit running 120 nights across roughly 40 stays absorbs €1,800 to €2,800 a year before linen hire. That single line often exceeds the entire annual management fee on an equivalent long-term tenancy.
...
Airbnb and Booking.com carry most Portuguese AL bookings, and their fee structures differ enough to change net revenue. Airbnb's host-only model typically deducts around 15% of the payout, while Booking.com commission generally runs 15–18% and is charged on the gross reservation value including the cleaning fee. Listing on both raises occupancy but means underwriting the higher of the two rates, not the lower.
...
Portuguese rental income requires an annual filing whichever strategy you run, but AL adds a layer. Short-let operators register with Finanças as Category B, which brings quarterly obligations and, above the registration threshold, IVA. Budget €400 to €900 a year for accountancy on an AL unit against €150 to €400 for a long-term tenancy, on top of the fiscal representative fee a non-resident already carries.
...
## What the Home Costs to Keep, With or Without a Manager

Management fees are a choice. The costs below arrive whether you appoint anyone or not, and whether or not the property is occupied.

| Item | Basis | Arrives even when empty |
|---|---|---|
| Condominium charge | Building budget, scaled to your permilage share | Yes |
| IMI | 0.3% to 0.45% of rateable value for urban property, set by the council | Yes |
| AIMI | 0.7% above EUR 600,000 of taxable value per owner | Yes |
| Buildings insurance | Mandatory with a mortgage, sensible without | Yes |
| Standing utility charges | Water and electricity standing charges continue on an empty home | Yes |
| Reserve for repairs | A percentage of value set aside annually | Yes |
| Special assessments | Voted by the condominium for major works | Yes, and without warning |

The reserve is the line owners skip. A building votes a facade or lift project, the assessment lands with a few months of notice, and an owner who budgeted only the routine charge has to find a four-figure sum. Before buying into any building, ask for the minutes of the last two general meetings and any approved works not yet billed.

Coastal exposure and building age both raise the routine number. Salt air, older stone or masonry construction and a pool each add a recurring cost that a mainland modern apartment does not carry.

## Renovation: What It Costs and What It Saves Later

Renovation sits between maintenance and investment, and it has a tax consequence most owners discover too late.

| Element | What drives it |
|---|---|
| Cost per square metre | Specification, access, and whether the building is listed or in a protected zone |
| Labour and materials split | Labour dominates on refurbishment, materials on new fit-out |
| Licensing | Structural work, facades and anything touching the building envelope need an obras licence |
| VAT treatment | A reduced 6% rate applies to qualifying housing works under the current regime |
| Running it from abroad | A local project manager or a power of attorney, plus a payment schedule tied to stages |

The tax point: documented improvement works, invoiced properly against your NIF, reduce the taxable gain when you sell. Cash work with no invoice does not. Over a decade of upgrades the difference is routinely larger than an estate agent's commission, and the only way to capture it is to keep every invoice from the day you buy.

Licence timing is the other trap. An obras licence is a municipal process with its own queue, and a renovation planned around a summer letting season that starts before the licence issues is a renovation that misses the season. The reduced VAT position is covered in [the 6% VAT on housing works guide](/guides/portugal-6-percent-vat-housing-works/).

## How do you choose and vet a property manager?

Selecting the right management company is one of the highest-leverage decisions for a non-resident Portugal property investor. A 4 percentage point difference in AL fees on €30,000 of annual gross bookings is €1,200 a year, but a manager who runs 65% occupancy instead of 78% costs several times that.

Insider tip: ask for a sample monthly statement and the current occupancy figure for two comparable units in the same municipality before you sign anything. Managers who quote a headline percentage without naming exclusions almost always bill cleaning, linen, consumables, and out-of-hours callouts separately, which is how an 18% quote becomes an effective 30% of gross. Our clients get the exclusion list in writing and a named contact for maintenance decisions above a set euro threshold, because remote owners approving every €80 repair by email lose guest reviews faster than they save money.
...
## Long-term against short-let management on one unit

Management pricing differs enough between strategies to change which one wins. On a €320,000 Porto two-bedroom letting long-term at €1,350 a month, management at 8% to 12% costs €1,296 to €1,944 a year and covers tenant sourcing, rent collection and coordination. Run the same unit as Alojamento Local grossing perhaps €24,000 and management runs 18% to 25%, €4,320 to €6,000, with cleaning billed separately at €45 to €70 per changeover — another €1,800 to €2,800 across roughly 40 stays. Add platform commission of 15% to 18% and the operating cost gap between the two strategies exceeds €8,000 a year on the same apartment. Get management quoted as a total annual figure including cleaning and platform fees, not as a headline percentage of gross revenue.
