---
title: "Escritura in Portugal: the Notary Completion, Step by Step"
...
readingTime: 24
featured: true
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/escritura-notary-portugal-property/hero"
heroImageAlt: "Fishing boats drawn up on the beach at Cascais"
heroImageCredit: "Rafał Klisowski / Wikimedia Commons"
heroImageLicence: "CC BY-SA 3.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Boats_at_Cascais_beach_-_panoramio.jpg"
heroImageWidth: 1280
heroImageHeight: 852
relatedSlugs:
...
<TldrBlock text="Escritura = final deed at notary or Casa Pronta. Pay IMT + 0.8% stamp duty before the appointment. Typical timeline: 30-60 days after CPCV (cash) or 60-90 days (mortgage). Bring NIF, tax receipts, title certificate, habitability licence, and balance funds. Remote buyers use scoped procuração. Keys on deed day; Conservatória registration within 1-5 days." />
...
Insider tip: book the deed slot tentatively as soon as the IMT payment is initiated rather than after the receipts arrive. Notary diaries in Lisbon and Porto run weeks ahead in peak season, and the slot is the one part of the completion chain that cannot be accelerated by paying more.
...
<InlineCta
  ...
  ctaId="guide_mid_escritura_notary_portugal_property"
...
The escritura requires the buyer, the seller and the notary, with attendance rules strict on identity and authority and flexible on professional support. A buyer who cannot attend signs through a notarised power of attorney, which is how most remote purchases complete.
...
Document failures are the leading cause of postponed deeds, and the pack should be assembled at least 10 working days before the appointment. The caderneta predial, the certidão de teor, the licença de utilização, the energy certificate and proof of IMT and stamp duty payment are the load-bearing items.
...
A standard residential escritura runs 60 to 90 minutes, and complex mortgages or co-ownership structures take up to 2 hours. The notary verifies identity and authority, reads the deed aloud, confirms that IMT and stamp duty are paid, and witnesses signature and payment of the balance.
...
Escritura-stage costs sit on top of the IMT and stamp duty already paid and typically run to a low four-figure sum: notary fees, land registry charges, and any mortgage registration. Model them inside the [cost of buying guide](/guides/cost-of-buying-property-portugal/) budget rather than as an afterthought.
...
Ownership begins practically at key handover and administratively over the following 30 days. Utilities transfer into your name, the property is registered for IMI in the new owner's tax file, condominium membership updates, and insurance starts. None happens automatically.
...
Notary capacity and Casa Pronta availability vary by district, and that decides how far ahead an appointment must be booked. Lisbon, Porto and the central Algarve run the heaviest volumes and the longest waits; smaller municipalities offer more flexibility and fewer Casa Pronta desks.
...
Portuguese Estate is the editorial desk for portuguese-estate.com. We do not attend notaries or hold client funds. We ensure international buyers arrive at the deed with the same checklist our lawyers use on tier A files.
...
Coordinate with your independent Portuguese lawyer for registo predial, tax filing, and deed attendance. Return to the [foreign buyer hub](/guides/how-to-buy-property-portugal-step-by-step/) for eligibility and financing context.
...
One checklist prevents most postponed deeds, and it runs 7 to 10 days before the appointment rather than on the morning. Confirm the registry position is clean, the licença de utilização matches the building, IMT and stamp duty are paid, and every party's authority is documented.
...
After the escritura the work shifts from acquisition to ownership administration, and four items carry deadlines: registration confirmation at the Conservatória, utility transfers, IMI registration in your tax file, and buildings insurance from the day risk passes.
...
For financing context on the next purchase or refinance, see [non-resident mortgage Portugal](/guides/portugal-mortgage-rates-foreigners-2026/). For the full chronological spine, return to [how to buy property step by step](/guides/how-to-buy-property-portugal-step-by-step/).
