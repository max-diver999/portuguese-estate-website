...
readingTime: 20
featured: true
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/long-term-vs-holiday-rental-portugal/hero"
heroImageAlt: "Sagres town above the Atlantic, western Algarve"
heroImageCredit: "pictures Jettcom / Wikimedia Commons"
heroImageLicence: "CC BY 3.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:January_Beaches_Sagres_Portugal_-_Magic_Portugal_Photography_1991_Sagres_Town_Atlantic_Ocean_-_panoramio.jpg"
heroImageWidth: 1280
heroImageHeight: 893
faq:
...
Long-term and holiday rental operate under entirely different Portuguese law, and conflating them is the most common investor mistake. Long-term letting falls under the urban lease regime with no licence required; short-term letting requires RNAL registration under DL 76/2024, municipal approval, and condominium consent. A yield projection built on the wrong framework is not conservative or aggressive; it is simply inapplicable.
...
Lisbon's Regime Municipal de Alojamento Local is the most restrictive municipal framework in Portugal, and it removes the choice entirely across large parts of the historic centre. Containment applies at statistical subsection level, so the decision between short and long letting is made by the address rather than by the owner.
...
The Algarve produces Portugal's strongest short-let nightly rates and its most polarised calendar. Revenue concentrates into roughly 5 months from May to September, and the remaining 7 contribute little on the resort strip. Annual income projected from a peak-season rate overstates the result by a wide margin.
...
<InlineCta
  ...
  ctaId="guide_mid_long_term_vs_holiday_rental_portugal"
...
The two strategies are taxed differently enough to change the ranking between them. Long-term rental income is taxed at 28% for non-residents, reduced on longer lease terms, while Alojamento Local income is assessed under the simplified regime on a coefficient of gross receipts and can attract additional municipal charges. Model both on the same unit before choosing:
...
Operational load, not yield, is what most often pushes non-resident owners from short-term back to long-term letting. Alojamento Local requires cleaning turnover, guest communication, dynamic pricing and licence compliance, and full-service management typically costs 20–30% of gross revenue against 8–12% for a long-term tenancy. That gap alone can erase the headline yield advantage of a seasonal Algarve unit.
...
For buyers considering long-term letting, Portugal's moderate-rent (renda acessível) programme adds a tax dimension that can materially improve net return, particularly across the Lisbon and Porto metropolitan areas. Letting at or below the municipal rent cap for a qualifying term reduces the rate on rental income and, under DL 97/2026, can support an IMT position that a market-rate let cannot.
...
The decision is not a single right answer but a function of three location-specific inputs: RNAL eligibility, the depth of local long-term tenant demand, and realistic annual occupancy. Central Lisbon fails the first test outright under RMAL containment; the Algarve passes it but concentrates roughly 70% of annual revenue into five months; Porto and Braga clear the second test on student and professional demand.
...
The choice between short and long letting is settled by documents rather than by preference, and four of them decide it: the municipal containment position for the address, the condominium's DL 76/2024 vote, the RNAL status if a licence already exists, and the building's suitability for guest turnover.
...
## Model both strategies on the same unit

Before you choose long-term or holiday rental, run the same apartment through [gross vs net yield](/guides/portugal-rental-yield-guide/) and the [rental yield calculator walkthrough](/guides/portugal-rental-yield-guide/). A €420,000 Lisbon T2 in a non-contained parish might show 5.0% gross long-term (€1,750/month) versus 6.5% gross AL on paper, but after 22% management, cleaning, and Category B tax the AL net often lands within 0.5 points of long-term. In contained parishes the AL column is not legally available for new operators, so the comparison collapses to long-term versus [moderate-rent](/guides/moderate-rent-tax-incentives-portugal-2026/) only.

Link your strategy to the [buy-to-let hub](/guides/portugal-property-investment-guide/) if you are acquiring specifically for income, and to [Lisbon AL containment rules](/guides/lisbon-alojamento-local-containment-zones/) before signing any CPCV on a Chiado or Alfama listing marketed with STR revenue.

## The same unit, modelled both ways

Run one property through both strategies before choosing. A €300,000 Algarve two-bedroom let long-term at €1,150 a month grosses €13,800, a 4.6% yield, with roughly 10% management and predictable costs, leaving about €10,300 net. Run as Alojamento Local it might gross €26,000 across a season-weighted year, but deduct 20% to 30% management, cleaning at €45 to €70 per changeover across some 40 stays, platform commission of 15% to 18%, RNAL insurance from €150 and higher accountancy, and net lands nearer €15,000. The short-let route wins by roughly €4,700 a year and costs materially more work, more compliance and more vacancy risk. That gap, not the gross figures, is the decision. Run the comparison on the specific unit and its verified RNAL position, never on a regional average taken from a portal.
