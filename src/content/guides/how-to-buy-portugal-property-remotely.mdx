---
title: "Buy Portugal Property Remotely: 2026 Power of Attorney"
description: "Buy Portugal without flying: NIF, procuração, video CPCV, lawyer escrow, escritura by POA. Timeline for UK, US and UAE remote buyers."
pubDate: 2026-06-17
...
readingTime: 18
featured: true
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/how-to-buy-portugal-property-remotely/hero"
heroImageAlt: "Belém Tower in Lisbon"
heroImageCredit: "Lisbon Photoshoots / Wikimedia Commons"
heroImageLicence: "CC BY-SA 4.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Bel%C3%A9m_Tower_in_Lisbon,_Portugal.jpg"
heroImageWidth: 1280
heroImageHeight: 854
relatedSlugs:
...
<TldrBlock text="Remote purchase path, fiscal representative for NIF → notarised procuração to your lawyer → remote bank KYC → video CPCV with 10-30% deposit in lawyer escrow → due diligence → IMT paid → escritura signed by lawyer at notary. Brazil, UK, and UAE buyers are the largest remote cohorts. Fully legal without travel, but visit at least once before an irrevocable deposit. See step-by-step hub for the full timeline." />
...
This guide is for buyers who want to buy Portugal property remotely and need to understand the mechanics, not whether foreigners can buy at all. For eligibility, regional strategy, and tax overview, start with our [buy property in Portugal as a foreigner](/guides/how-to-buy-property-portugal-step-by-step/) hub. For the chronological purchase sequence, cross-read the [step-by-step purchase guide](/guides/how-to-buy-property-portugal-step-by-step/). This page focuses on the remote layer: procuração, fiscal representation, video signatures, escrow, and the risks of never visiting.

<InlineCta
  headline="Buying Portugal property from abroad?"
  subtext="We connect remote buyers with fiscal reps, lawyers, and vetted listings, reply within one business day."
  ctaId="inline_remote_buy"
  whatsappMessage="Hi Portuguese Estate! I want to buy Portugal property remotely and need help with NIF, procuração and a shortlist."
/>

## Who Buys Portugal Property Remotely in 2026?

Remote purchase is the default path for several large buyer cohorts rather than a workaround: Brazilian, British, American and Gulf buyers with strong ties to Portugal and primary lives elsewhere. Portuguese law accommodates it fully through the procuração, and the whole transaction can complete without the buyer entering the country.
...
Brazilian buyers led foreign transaction volume in 2025, and a significant share complete at least one signature round remotely. Our dedicated [Brazilian buyers in Portugal](/move-to-portugal/by-nationality/) segment guide covers Lusophone document advantages, BRL banking friction, and diaspora vs non-resident tax paths. UK buyers face similar remote mechanics with heavier apostille requirements. UAE buyers often delegate entirely to a Lisbon law firm and visit only for key handover.
...
Every remote purchase starts with the NIF, the 9-digit Portuguese tax number. Without it you cannot open a bank account, sign a CPCV, pay IMT or register utilities. A non-resident obtains one through a fiscal representative, and the process runs in week 1 rather than alongside the offer.
...
Plan 1-3 weeks for account activation. Do not sign a CPCV with a 5-day deposit deadline until your IBAN accepts inbound transfers. If you plan to finance, read our [non-resident mortgage Portugal](/guides/portugal-mortgage-rates-foreigners-2026/) guide before account opening so you know which bank handles both account and loan.

## Step 4: Property Search and Video Viewing

Remote search works for filtering and fails for condition assessment. Portals and video tours narrow a shortlist efficiently, and neither shows damp, noise, orientation or what the neighbouring plot is zoned for. Independent verification by a surveyor or a trusted local is the step that closes the gap.
...
Start the mortgage pre-approval conversation before you make an offer. Pair this section with our full [non-resident mortgage guide](/guides/portugal-mortgage-rates-foreigners-2026/) for bank-by-bank expectations.
...
Buying remotely is legal and buying blind is a separate choice with consequences video cannot remove. Damp, noise, orientation, the condition of the building's common parts and what the neighbouring plot is zoned for are all invisible on a screen and all expensive to discover after completion.
...
One document pack assembled before you engage anyone prevents most remote-purchase delays. Passport, proof of address, proof of funds, the draft procuração and any income documents all need apostille and certified translation, and those lead times run to weeks rather than days in several jurisdictions.
...
A remote purchase runs 9 to 16 weeks from offer to registered ownership, roughly 1 to 2 weeks longer than an in-person one. The additional time is apostille and courier on the power of attorney rather than any slower step inside Portugal, and it front-loads rather than delaying completion.
...
Remote purchase works where the property is standard, the location is known to the buyer and the diligence can be delegated to professionals. It works badly on rural land, on renovation projects and on anything where condition rather than title is the main risk.
...
Remote deals fail predictably when buyers skip steps that on-site purchasers perform by instinct. Each of these failure modes is procedural rather than bad luck, which is why each has a named preventive step.
...
## What a remote purchase costs and where it slows down

A remote purchase is entirely legal and routinely done, but it front-loads paperwork. A procuração drawn by a Portuguese lawyer, signed before a notary abroad and apostilled, typically costs €200 to €600 and takes one to three weeks depending on the consulate. The NIF can be obtained through a fiscal representative at €150 to €500 a year. Bank onboarding is the usual bottleneck for non-EU applicants and should start before, not after, the CPCV. The purchase costs are unchanged (flat 7.5% IMT, 0.8% stamp duty, roughly 2.5% professional fees), so remote buying adds time and about €500, not a different tax position. Scope the power of attorney narrowly to the specific property and transaction rather than granting general authority over your affairs in Portugal.
