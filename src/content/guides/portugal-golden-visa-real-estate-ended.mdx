...
readingTime: 20
featured: true
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/portugal-golden-visa-real-estate-ended/hero"
heroImageAlt: "South side of Praca Marques de Pombal in Lisbon"
heroImageCredit: "Philip Mallis from Melbourne / Wikimedia Commons"
heroImageLicence: "CC BY-SA 4.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:South_side_of_Praca_Marques_de_Pombal_in_Lisbon,_Portugal_(55109032830).jpg"
heroImageWidth: 1280
heroImageHeight: 964
faq:
  ...
  - question: "What is D7 visa and how does it compare to Golden Visa?"
    answer: "D7 is passive income visa requiring ~€920/month income proof, lower investment but requires more physical presence and different benefits than Golden Visa program."
...
For what the programme offers now that the property route has gone, see [the Portugal Golden Visa guide](/move-to-portugal/golden-visa/). This page is the record of what closed and when.

**Yes, officially closed October 7, 2023 under Law 56/2023.** Real estate (residential and commercial) is no longer a qualifying investment for Portugal Golden Visa. Existing permits continue; new applicants use €500k fund route or €250k cultural heritage path.

<TldrBlock text="Portugal closed the Golden Visa real estate route in October 2023 under Law 56/2023. Property buyers may still invest via CMVM-regulated funds (€500,000 minimum) or pursue D7/D8 visas separately from any home purchase." />

The program shift eliminates a pathway that attracted over 25,000 investors since 2012. Law 56/2023 represents a strategic pivot toward fund-based investments while maintaining minimum physical presence (7 days/year). This change reflects broader European policy trends restricting property-based investor visas, with Portugal joining Spain (April 2025 closure) and others in limiting real-estate-linked residency programs.

## Golden Visa Program Termination

Law 56/2023, part of the Mais Habitacao package, was published on 4 August 2023 and took effect on 7 October 2023, terminating every real estate pathway into the Golden Visa. The removal covered direct acquisition, capital transfer and, critically, funds holding Portuguese real estate.
...
Five qualifying routes remain under AIMA's current guidance, and the EUR 500,000 CMVM-regulated fund carries almost all the volume. Company investment, arts and heritage support, research funding and job creation make up the rest, and none of them admits residential property.
...
The presence requirement is 7 days in the first year and 14 days across each subsequent 2-year period, averaging roughly a week a year. That is the lightest obligation of any European residence-by-investment programme, and it is the feature the route is actually bought for.
...
<InlineCta
  ...
  ctaId="guide_mid_portugal_golden_visa_real_estate_ended"
...
Three alternatives reach the same residence permit without EUR 500,000 of capital. The D7 asks for roughly EUR 920 a month in passive income, the D8 roughly EUR 3,680 in remote earnings, and both expect you to live in Portugal rather than visit it.

### D7 Visa (Passive Income/Retirement)

Financial Requirements:
- Minimum income: €920/month (2026 rate)
...
| Income requirement | €920/month | None |
...
- IFICI (NHR 2.0) benefits if your activity qualifies (NHR itself closed to new applicants at the end of 2024)
- Property ownership without visa restrictions
- Standard income and wealth tax obligations

## European Golden Visa Alternatives

The European field narrowed sharply in 2025. Spain abolished its programme under Organic Law 1/2025 with effect from 3 April 2025, and the Court of Justice closed Malta's citizenship scheme on 29 April 2025, leaving Greece as the main property-admitting alternative.
...
A EUR 500,000 fund position carries risks a property purchase does not: no control over asset selection, no liquidity for at least 5 years, management fees compounding across the hold, and a secondary market that depends on finding a buyer who also wants the residency benefit.
...
Three professionals are needed rather than one: a Portuguese immigration lawyer for the application and renewals, an independent adviser on fund selection who is not selling the fund, and a tax adviser covering both Portugal and your home jurisdiction across the full holding period.
...
## What the route's closure actually moved
...
## What happened to demand after the property route closed?

The closure did not empty the market, it changed who was buying. Non-resident purchases fell 13.3% to 8,471 in 2025, yet the national index still rose 17.6% across 169,812 transactions, which shows domestic and resident-foreign demand absorbing the shortfall comfortably.

Full 2025 series: [the record year](/guides/portugal-property-market-record-2025-ine-data/).

The composition shift is the more useful signal. Brazilian-born buyers led nationality counts at 9,808 purchases in 2025, up 27.5%, but many of those are Portuguese tax residents rather than holiday-home non-residents, so they were never Golden Visa candidates. The route that closed served a narrower cohort than the headlines suggested.

For cross-border cash buyers, confirm bank source-of-funds documentation early. Portuguese banks apply anti-money-laundering checks that routinely add weeks to a foreign transfer, and the delay lands on the completion date rather than on the bank.
...
Buying a home confers no residency, but it does confer annual obligations: IMI at 0.3% to 0.45% of VPT, condominium charges, and a fiscal representative for non-EU owners. Those continue whether or not a visa application succeeds.

The D7 and D8 routes lead to Portuguese tax residency, which in turn makes the 7.5% non-resident IMT refundable if residency lands within 24 months of purchase. That link between the visa decision and the tax bill is the one place where property and residency genuinely interact.
...
The property route closed in 2023 and the questions it raised did not. Buyers still need the current residence options, the fund route mechanics if capital rather than presence is the constraint, and the naturalisation position after the 2026 nationality law changed the timeline.

If the residency question is settled and the purchase question is not, these are the next pages to read:

- [Residency options without the Golden Visa](/guides/portugal-residency-options-without-golden-visa/)
- [The D7 visa and property](/guides/portugal-d7-visa-property/)
- [Golden Visa funds in 2026](/guides/portugal-golden-visa-fund-investment-2026/)
- [Buying property as a foreigner](/guides/how-to-buy-property-portugal-step-by-step/)
...
- The fund is CMVM-regulated, if the €500,000 route is the objective
- The property purchase and the residency application are documented as separate decisions
- Minimum stay obligations are understood before committing capital
- Legal advice on the visa route comes from an immigration lawyer, not the property seller
...
| Income requirement | ~€920/month passive income (2026 minimum wage reference) | ~€3,680/month from remote employment or freelance work | None, investment qualifies directly |
...
| Path to citizenship | 10 years with A2 Portuguese, 7 if EU or CPLP | Same | Same |
...
For remote workers earning above €3,680/month, the **D8 visa** offers similar residency without the passive-income requirement. You can buy property for personal use while maintaining your remote employment. The D8 suits younger buyers and digital professionals relocating to Portugal for lifestyle reasons.

The **Golden Visa fund route** suits buyers who want EU mobility and an eventual path to citizenship, now a ten-year one for most non-EU nationals, but cannot or do not wish to relocate physically. The 7-day average presence requirement is the lightest in Europe. However, tying €500,000 in an illiquid fund for five years carries opportunity cost and market risk that neither D7 nor D8 impose.

None of these visas restricts your ability to purchase Portuguese property separately. For the step-by-step buying process, see [buy property as a foreigner](/guides/how-to-buy-property-portugal-step-by-step/).

## Citizenship timeline and legislative uncertainty

The timeline on this page changed in 2026, and it changed against investors. Lei Orgânica n.º 1/2026, published on 18 May 2026 and in force from 19 May, replaced the five-year naturalisation rule with seven years of legal residence for EU and CPLP nationals and ten years for everyone else. American, British, Canadian and Emirati applicants fall in the ten-year group. The A2 Portuguese language test and clean criminal record still apply, alongside broader integration requirements covering Portuguese culture, history and civic duties.

Two further changes matter as much as the headline number. The clock now runs from the date the residence permit is issued rather than the date it was applied for, reversing a 2024 amendment that had protected applicants against AIMA's own delays. And only lawful residence covered by a valid permit counts toward the total.

Article 7 of the new law preserves the previous wording for administrative procedures pending on the date it entered into force. That protects a nationality application already filed on 19 May 2026. It does not protect someone who holds a Golden Visa and has not yet reached the old five-year mark, which is most current holders.

Processing backlogs at AIMA (Agência para a Integração, Migrações e Asilo, the successor to SEF) sit in front of that clock rather than inside it, which is the practical sting of the issuance rule. Renewal and permit waits have run 6–12 months beyond schedule, with some cases exceeding 18 months, and citizenship applications handled by the Conservatória dos Registos Centrais add a further 12–24 months at the end.

A realistic timeline for a Golden Visa fund applicant from outside the EU and CPLP, starting in mid-2026:

| Stage | Estimated duration | Cumulative |
|---|---|---|
| Fund investment and application submission | 2–4 months | 4 months |
| Initial approval and permit issued: the clock starts here | 8–18 months | 22 months |
| Ten years of legal residence from issuance | 120 months | 142 months |
| Citizenship application processing | 12–24 months | 154–166 months |
| Total estimated elapsed time | 13–14 years from initial investment | |

That is roughly double the figure the same table carried before May 2026, and it is the number to plan against unless a court says otherwise.

Two legal challenges are live. A Golden Visa investor challenge to the retroactive effect was filed in December 2025 and remains unresolved. Separately, a decree treating loss of nationality as a criminal penalty is suspended pending preventive constitutional review, after the Constitutional Court struck down several provisions in December 2025.
...
- Do not structure major life decisions around an assumed citizenship date. A plan that only works if the rules hold for ten years is a plan with a decade of legislative risk in it.
- Separate the two objectives. Permanent residency at year five is unchanged and is what most buyers actually need; citizenship is a longer and now less certain second stage.

Portugal's residence routes remain among the more accessible in the EU. Its citizenship route no longer is, and the word "guaranteed" does not belong in any honest description of the process. For the full picture see [Portuguese citizenship by investment](/move-to-portugal/citizenship-by-investment/), and for how property purchase fits alongside residency planning, see [Portugal property investment guide](/guides/portugal-property-investment-guide/).
...
## Residency routes after the property option closed
...
| Topic | Guide |
|---|---|
| CMVM fund route (€500k) | [Golden Visa Fund Investment 2026](/guides/portugal-golden-visa-fund-investment-2026/) |
| GV fund vs buying a home | [Golden Visa vs buying a home](/move-to-portugal/golden-visa/) |
| Residency without Golden Visa | [Residency Options Without Golden Visa](/guides/portugal-residency-options-without-golden-visa/) |
| D7 passive income + property | [D7 Visa Property Guide](/guides/portugal-d7-visa-property/) |
| D8 digital nomad + property | [Digital Nomad Visa Property](/guides/portugal-digital-nomad-visa-property/) |

## What replaced the property route, and what it costs

Law 56/2023 closed the real estate and capital transfer routes in October 2023, and nothing has reopened them. The routes that remain are a €500,000 investment in a CMVM-regulated fund held for five years, job creation, and research or cultural contributions. For a buyer whose real goal is a Portuguese home, the practical answer is usually not a Golden Visa at all: the D7 requires passive income near €920 a month in 2026 and the D8 around €3,680, both far below €500,000 of locked capital, and a purchased property satisfies the accommodation requirement either route needs. Buying property still confers no immigration status by itself. Anyone still marketing a property purchase as a Golden Visa route in 2026 is describing a programme that closed three years ago.
