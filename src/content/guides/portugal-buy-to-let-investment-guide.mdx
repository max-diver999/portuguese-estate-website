...
description: "Buy-to-let Portugal 2026: gross yields 4.3–7%, AL licensing post-DL 76/2024, tax stack, mortgage rules, and what changed for landlords since 2024."
pubDate: 2026-06-17
...
readingTime: 18
featured: true
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/portugal-buy-to-let-investment-guide/hero"
heroImageAlt: "Panorama-Lisbon-Graca — buy-to-let investment"
heroImageCredit: "acediscovery / Wikimedia Commons"
heroImageLicence: "CC BY 4.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Panorama-Lisbon-Graca.jpg"
heroImageWidth: 1280
heroImageHeight: 960
faq:
...
<TldrBlock text="Buy-to-let in Portugal offers gross yields of 4.3–7% and net yields of 2.8–4.5% after taxes and costs. Non-residents pay 28% on net rental income; moderate-rent long-term contracts can reduce this to near 0%. AL (Airbnb) licensing is blocked in Lisbon containment zones since DL 76/2024 and the December 2025 RMAL update. Transaction costs total 7–10%. Portuguese Estate advisors recommend a full tax-stack net yield model before committing to a strategy." />
...
This guide covers the full buy-to-let picture: yields by region, the complete tax stack, AL licensing rules, mortgage parameters, worked examples at €350k–€600k, and practical observations from Portuguese Estate advisors.

## The Two Portuguese Rental Markets

Portugal has two structurally distinct rental markets, and the choice between them should drive property selection rather than follow it. Long-term letting under the urban lease regime delivers roughly 4.3–5.8% gross with year-round occupancy; Alojamento Local can reach 6–8% gross in the Algarve but concentrates revenue into about five months and depends entirely on an RNAL registration the seller may not be able to transfer.
...
The table below uses Portuguese Estate field-calibrated gross yields and indicative net figures. Net calculations assume non-resident status, no mortgage, and typical management plus IMI costs.
...
Every buy-to-let calculation must account for four tax layers, and omitting any one produces an overstated net yield. Non-residents pay flat 7.5% IMT on acquisition from 1 September 2026 under DL 97/2026, 0.8% stamp duty, annual IMI of 0.3–0.45% on the VPT, and 28% on rental income. Together these move a 5.0% gross yield closer to 3.0% net.
...
<InlineCta
  ...
  ctaId="guide_mid_portugal_buy_to_let_investment_guide"
...
Alojamento Local licensing under DL 76/2024 operates at three levels — national registration, municipal containment rules, and building-level condominium consent — and a property can fail at any one of them. Lisbon blocks new registrations across most central parishes, Porto restricts the UNESCO area, and several Algarve municipalities apply capacity caps. Confirm all three before the CPCV:
...
Portuguese banks lend to non-residents for investment property at lower loan-to-value than for residents, typically 60–70% against 80–90%, with longer approval timelines and a compulsory life policy. Bank valuation is the binding constraint on off-plan purchases, because it frequently lands below the developer price list and the shortfall must be funded in cash.
...
## What changed for buy-to-let between 2024 and 2026ns

Portuguese Estate advisors have worked with buy-to-let investors across Lisbon, Porto, and the Algarve through the post-DL 76/2024 transition. Four patterns recur across transactions:
...
## The tax stack on a €350,000 buy-to-let

Four layers determine what a Portuguese buy-to-let actually returns. On a €350,000 purchase a non-resident pays flat 7.5% IMT of €26,250 and 0.8% stamp duty of €2,800 at acquisition, plus about €8,750 in professional fees. Annually, IMI at 0.35% of a VPT near €280,000 costs €980, and rental income is taxed at 28% net of documented expenses. On exit, 50% of the gain is taxed at progressive IRS rates of 14.5% to 48%. A €1,450 monthly rent grossing 4.97% therefore delivers closer to 2.4% after costs and income tax. Every one of those four layers is deductible against something, which is why documentation drives the return. Keep every invoice from the day of purchase, including improvement works, because the same receipts reduce both annual income tax and the eventual gain.
