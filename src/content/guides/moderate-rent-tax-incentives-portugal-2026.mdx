...
heroImageAlt: "Eclectic Streetfront on Rua 5 de Outubro, Porto, Portugal — moderate-rent tax incentives"
...
**UK buyers** post-Brexit are treated as non-residents in most cases and follow the refund pathway described above. Several Portuguese Estate clients from the UK have successfully recovered full IMT on Lisbon properties in the €450,000–€600,000 range after committing to moderate-rent programs. The critical timing rule remains consistent: register with the municipality before signing the first tenant lease. Signing the lease before registering is the procedural error the regime punishes hardest, because a late registration application can be rejected by both the municipality and AT and there is no retrospective route back in.
