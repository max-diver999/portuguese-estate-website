---
title: "Moderate Rent Portugal 2026: IMT Exemption for Landlords"
description: "Cut IMT to zero via Portugal's moderate-rent route: rent caps by municipality, 8-year lease commitment, and how it interacts with the 7.5% non-resident rate."
pubDate: 2026-06-17
...
readingTime: 14
featured: false
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/moderate-rent-tax-incentives-portugal-2026/hero"
heroImageAlt: "Eclectic Streetfront on Rua 5 de Outubro, Porto"
heroImageCredit: "Dale Cruse - 10M views from San Francisco, CA, USA / Wikimedia Commons"
heroImageLicence: "CC BY 4.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Eclectic_Streetfront_on_Rua_5_de_Outubro,_Porto,_Portugal_(54832827515).jpg"
heroImageWidth: 1280
heroImageHeight: 720
...
<TldrBlock text="Moderate-rent is a policy trade: lower rent caps and long lease lock-in for upfront IMT savings. Verify municipal program eligibility before CPCV, not after purchase." />
...
The moderate-rent IMT exemption is a complete waiver rather than a reduction, and it applies to qualifying purchases up to EUR 633,000. Above that ceiling the exemption disappears entirely rather than tapering, which makes the threshold a hard cliff in any purchase decision near it.
...
The rent cap is set per square metre and varies by whether the municipality falls inside an official metropolitan area. Standard areas cap at EUR 5.00 per square metre a month, Greater Lisbon and Greater Porto at EUR 7.50, so an 80 m2 apartment caps at EUR 400 or EUR 600 respectively.
...
<InlineCta
  ...
  ctaId="guide_mid_moderate_rent_tax_incentives_portugal_2026"
...
DL 97/2026 changed the non-resident position entirely from 1 September 2026: a flat 7.5% applies to the full acquisition value of urban residential property, with no progressive bands and no thresholds. That single rate is what a moderate-rent commitment then works against.

### Dual Tax Rate Challenge

From 1 September 2026, non-residents face a single IMT rate:
- Flat 7.5% on the full acquisition value of urban residential property, at any price
- No progressive bands, and no value threshold below which a lower rate applies
- The standard reductions and exemptions available to residents are disapplied
...
Registration runs through the municipality rather than the tax authority, and the sequence is unforgiving. The application needs the deed, IMT proof, an energy certificate rated C or better, a compliant lease template and an owner tax declaration, and processing takes 30 to 60 days.
...
Breaking the 8-year commitment triggers full repayment of the exempted IMT plus 4% annual interest from the exemption date, a 20% penalty on the principal and administrative fees of EUR 200 to EUR 500. On a EUR 28,000 exemption broken in year four, that is a five-figure clawback.
...
Moderate-rent income is taxed as Category F rental income at the standard scale of 14.5% to 48%, with no concessionary rate attached to the programme itself. Management fees, maintenance, insurance, IMI and depreciation remain deductible in the ordinary way.
...
The trade is a certain front-loaded IMT saving against 8 years of capped rent, and the arithmetic decides it. On a EUR 500,000 Lisbon apartment the exemption is worth EUR 28,000 immediately, while the rent cap costs roughly half the market rent every month for 8 years.
...
The programme works best on a narrow property profile: priced between EUR 400,000 and EUR 633,000 to maximise the exemption against the ceiling, and located where the moderate-rent cap sits at 60% to 70% of market rent rather than at half of it.
...
Municipalities layer their own incentives on top of the national framework, and they differ materially. Lisbon adds a 30% IMI reduction for moderate-rent properties and a 21-day fast-track registration for complete applications, where other councils offer neither.
...
Moderate-rent applications fail on documentation and sequence rather than on eligibility. A missing energy certificate adds 30 to 60 days, an incorrectly measured floor area produces a non-compliant rent, and signing a tenant lease before registering is the error the regime punishes hardest.
...
The programme operates under Law 83/2019 and its amendments through Decree-Law 68/2020, which set national guidelines while leaving registration and some incentives to municipalities. Article 45-A defines the IMT exemption criteria and Article 12-B the rent calculation methodology.
...
Ownership structure changes the IMT position before the exemption is even considered. A Portuguese-incorporated entity is charged at resident rates rather than the flat 7.5% non-resident rate, and the moderate-rent exemption remains available regardless of ultimate beneficial ownership.
...
Managing a capped-rent property differs from managing a market one in a specific way: the tenant is paying below market, so retention is worth more than yield optimisation. Screening at 2.5 times monthly rent, a NIF for every tenant and 6 months of employment history are the standard tests.
...
The discount the cap imposes varies sharply by district, and that variation decides where the programme is worth using. Central Lisbon caps run 45% to 50% below market, Cascais and Sintra 35% to 40%, and Almada and Setubal 25% to 30%, which is why the outer belt models better.
...
Two variables outside Portuguese law shape the return for a foreign investor across an 8-year lock-in: the exchange rate against the euro for anyone earning outside the eurozone, and the ECB rate path, which drives mortgage cost and the relative attractiveness of a capped yield.
...
Most municipalities now accept digital applications, which has cut average processing from roughly 60 days to 30. Electronic rent reporting handles the annual compliance return, and the practical effect for a foreign owner is that the process can be run remotely by a lawyer.
...
The moderate-rent programme trades an IMT exemption for 8 years of capped rent, and judging that trade needs three other numbers: what IMT would otherwise cost at the flat 7.5% non-resident rate, what a market let would return, and what the property costs to hold annually.
...
## How the regime lands on different owner profiles
...
**UK buyers** post-Brexit are treated as non-residents in most cases and follow the refund pathway described above, on Lisbon properties typically in the EUR 450,000 to EUR 600,000 range where the exemption ceiling still allows it. The critical timing rule remains consistent: register with the municipality before signing the first tenant lease. Signing the lease before registering is the procedural error the regime punishes hardest, because a late registration application can be rejected by both the municipality and AT and there is no retrospective route back in.
...
## What the moderate-rent route is worth against a market let

The programme trades headline rent for a lower tax rate, and the arithmetic decides whether that is worthwhile. Take a Porto apartment that would let at market for €1,400 a month, €16,800 a year, taxed at 28% as non-resident rental income, leaving about €12,096. Letting at a municipal rent cap of, say, €1,150 gives €13,800 gross, but the reduced rate applicable to a qualifying long-term lease keeps materially more of it. The gap narrows to a few hundred euros a year, and the programme adds a multi-year commitment plus, under DL 97/2026, a route to an IMT position a market-rate let cannot reach. Model both on your own numbers before committing the term. Check the cap for the specific município: the ceiling is set locally and varies enough to flip the comparison entirely.
