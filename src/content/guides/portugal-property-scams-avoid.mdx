...
readingTime: 22
featured: true
heroImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Derelict_building_near_Praia_Santa_Eul%C3%A1lia%2C_Olhos_de_%C3%81gua%2C_14_January_2016_%281%29.JPG/1280px-Derelict_building_near_Praia_Santa_Eul%C3%A1lia%2C_Olhos_de_%C3%81gua%2C_14_January_2016_%281%29.JPG"
heroImageAlt: "Derelict building near Praia Santa Eulália, Olhos de Água — avoiding scams"
...
heroImageSource: "https://commons.wikimedia.org/wiki/File:Derelict_building_near_Praia_Santa_Eul%C3%A1lia,_Olhos_de_%C3%81gua,_14_January_2016_(1).JPG"
relatedSlugs:
...
<InlineCta
  ...
  ctaId="guide_mid_portugal_property_scams_avoid"
...
## The three checks that stop most Portuguese property fraud

Almost every avoidable loss in Portuguese property traces to a document that was never pulled. First, the certidão permanente from the land registry confirms the seller actually owns the property and reveals any mortgage or seizure — it costs around €15 online against a purchase price in the hundreds of thousands. Second, the licença de utilização confirms the building may legally be lived in; without it a bank will not lend and a resale is impaired. Third, on off-plan, the Decreto-Lei 67/2003 guarantee must name the exact seller entity on the CPCV and cover the cumulative sum paid. Add one rule: never transfer funds to an account provided by email without confirming the details by telephone against the lawyer's letterhead. Instruct your own independent lawyer rather than one introduced by the seller or developer, however convenient the introduction seems.
