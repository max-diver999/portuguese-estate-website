...
readingTime: 22
featured: true
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/portugal/guides/cpcv-promissory-contract-portugal/hero.webp"
heroImageAlt: "The marina at Povoa de Varzim, north of Porto"
heroImageCredit: "PedroPVZ / Wikimedia Commons"
heroImageLicence: "CC BY-SA 4.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Marina_Povoa2.jpg"
heroImageWidth: 1280
heroImageHeight: 755
relatedSlugs:
...
The CPCV must specify: deposit percentage or fixed euro amount, deadline for transfer (commonly 5-10 business days after signing), beneficiary IBAN (almost always the seller's lawyer's client account; a seller's personal account is a warning sign), and whether the deposit earns interest (rare in residential deals). Never wire a CPCV deposit to an account that is not the seller's registered solicitor client account without written lawyer confirmation.
...
If you withdraw without protection, the forfeited amount equals your deposit column. Treat that figure as your maximum loss and weigh it seriously before you sign.
...
<InlineCta
  ...
  ctaId="guide_mid_cpcv_promissory_contract_portugal"
...
Without this clause, a declined mortgage does not release you from the CPCV. Non-resident buyers face 70-80% maximum LTV and longer approval timelines than residents. Insert the clause before signing, because once a rejection letter arrives it is too late to add it.
...
Your lawyer adapts the final wording to Portuguese Civil Code form, but the operative logic should read clearly in English before translation. These five templates cover the majority of foreign-buyer files reviewed in Q2 2026.
...
For mortgage-specific timing and LTV caps that must match your clause, cross-read our [non-resident mortgage Portugal guide](/guides/portugal-mortgage-rates-foreigners-2026/). For AL transfer rules that determine whether clause 3 above can succeed, see the [Alojamento Local licence guide](/guides/alojamento-local-license-portugal/).
...
IMT for non-residents follows the flat 7.5% rate from 1 September 2026 under DL 97/2026. The escritura date determines which rate applies, and signing the CPCV earlier does not change that rate. If you sign a CPCV in June 2026 but complete in October 2026 as a non-resident, budget the higher flat rate. Model scenarios in our [IMT tax non-resident 2026 guide](/guides/imt-tax-non-resident-portugal-2026/).
...
You cannot pay IMT or complete escritura without a NIF. A CPCV with a 30-day completion deadline, signed while your bank account is still pending, guarantees a breach.
...
## Three CPCV clauses that decide the outcome

Three clauses do most of the work in a foreign buyer's promissory contract, and each is negotiable only before signature:
...
These field observations reinforce one rule: treat CPCV review as the highest-leverage legal checkpoint in the entire purchase and budget proper lawyer time for it in the gap between offer and escritura.
...
Pair Scenario D with our [how to buy Portugal property remotely](/guides/how-to-buy-portugal-property-remotely/) workflow: the CPCV must name the attorney-in-fact, specify electronic exchange of signed copies, and confirm the deposit wires only after the seller's lawyer acknowledges receipt of a valid procuração.

Buyers in Scenario F explored residency-linked investment before the [Golden Visa real estate route ended](/guides/portugal-golden-visa-real-estate-ended/). The CPCV should not include obsolete visa-allocation conditions; focus on clean title and tax domicile at escritura.
...
| Mortgage pre-approval letter | 2-4 weeks before CPCV | [Non-resident mortgage guide](/guides/portugal-mortgage-rates-foreigners-2026/) |
...
Portuguese Estate is the editorial and advisory desk for portuguese-estate.com. We do not draft CPCVs (independent Portuguese lawyers do), but we stop clients from signing agent templates that expose 10-30% deposits without usable suspensive protection.
...
4. Tax fourth: Model IMT under DL 97/2026 at the expected escritura date, since that date sets the rate. Non-resident flat 7.5% surprises buyers who signed in spring and complete in autumn.
...
- Porto: Competitive bidding pushed deposits to 20% without matching clause depth. Buyers who pre-agreed 15% with full suspensive package won on lawyer quality even with the smaller deposit.

We coordinate with independent Portuguese lawyers for registo predial, CPCV drafting, and câmara queries. We do not replace legal advice. We ensure the economic terms you negotiate match 2026 enforcement practice instead of 2019 verbal customs.

If you are early in the funnel, start with [can foreigners buy property in Portugal](/guides/can-foreigners-buy-property-portugal/) for eligibility, then the [foreign buyer hub](/guides/how-to-buy-property-portugal-step-by-step/) for the full sequence. Return here when you have a verbal offer and a lawyer engaged.
...
The CPCV is the middle of the sequence rather than the end. Before it, due diligence establishes what you are buying; after it, the escritura transfers ownership and the registry makes that transfer good against third parties. Each stage has its own checks and its own failure modes.
...
For the full post-CPCV sequence through escritura and registration, return to the [foreign buyer purchase guide](/guides/how-to-buy-property-portugal-step-by-step/) and the [step-by-step workflow](/guides/how-to-buy-property-portugal-step-by-step/).

## What is at risk at the CPCV stage

The CPCV is where the money becomes real. A typical deposit is 10% to 30% of price (€40,000 to €120,000 on a €400,000 purchase), and Portuguese law gives it teeth in both directions: a buyer who walks forfeits the deposit, while a seller who walks generally owes double it back. That symmetry is the reason the contract, not the escritura, is the document to negotiate. Fix the completion longstop date with refund mechanics, the condition on clean land registry title, the AL or RNAL position if short-let income is priced in, and, for a purchase straddling 1 September 2026, which party carries the IMT change if completion slips. Registering the CPCV at the land registry costs little and blocks the seller from transacting with a second buyer while your contract runs.
