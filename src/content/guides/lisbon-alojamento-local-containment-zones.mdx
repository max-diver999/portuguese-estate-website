...
readingTime: 11
featured: false
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/lisbon-alojamento-local-containment-zones/hero"
heroImageAlt: "Lisbon panorama from the Bairro Alto"
heroImageCredit: "Dudva / Wikimedia Commons"
heroImageLicence: "CC BY-SA 4.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Lisbon_panorama_from_the_Bairro_Alto.jpg"
heroImageWidth: 1280
heroImageHeight: 691
faq:
...
Decree-Law 76/2024, published in October 2024, reformed the RNAL and gave municipalities the legal basis for containment zones. Two provisions matter most to a Lisbon buyer: licences no longer transfer automatically on sale, and any condominium of 4 or more residential fractions can block new registrations by a two-thirds vote.
...
<InlineCta
  ...
  ctaId="guide_mid_lisbon_alojamento_local_containment_zones"
...
The December 2025 RMAL update published revised containment boundaries at statistical subsection level rather than parish level, which means a single parish can contain both open and closed areas. The parishes below carry substantial or complete containment, and the address decides the answer rather than the parish name.
...
Verifying AL status for a specific Lisbon address takes 3 steps and no more than an afternoon: locate the property's statistical subsection, check that subsection against the current RMAL containment map, then confirm the building's condominium has not passed a two-thirds vote blocking new registrations.
...
Containment splits the financial consequences in two. A property already operating with a valid licence keeps a permission new buyers cannot obtain, which is a durable premium. A property under consideration in a contained subsection must be underwritten on long-term letting at a flat 28% on net income instead.
...
Net yields after IMI (~0.45%), condominium (€80-120/month), management (10% LT or 20% AL), and non-resident withholding typically sit 1.5-2.0 points below gross. See [gross vs net yield](/guides/portugal-rental-yield-guide/) for line-by-line math.
...
Investors comparing Lisbon Chiado at 4.6% long-term net against Lagos AL at 3.8% net after seasonality should weigh liquidity and regulation equally with headline gross. Lisbon containment pushes capital toward outer parishes (Marvila, Olivais) and toward [buy-to-let planning](/guides/portugal-property-investment-guide/) that assumes long-term first.
...
Treat containment as a line item in the same spreadsheet you use for [property management fees](/guides/property-management-portugal-cost/) and [capital gains on exit](/guides/portugal-capital-gains-tax-property/). If AL is blocked, your gross yield ceiling is the long-term rent column from [highest rental yield areas](/guides/portugal-rental-yield-guide/), not the Airbnb screenshot in the listing pack. Non-resident buyers should also model IMI and AIMI before comparing Chiado to Marvila: a €520,000 contained purchase at 4.6% gross long-term often nets near 3.0% after costs, which is why many 2026 buyers pivot to outer Lisbon or Porto rather than pay an AL premium that cannot be replicated. Cross-check every assumption with the [rental yield calculator walkthrough](/guides/portugal-rental-yield-guide/) before you sign.

## Alternatives to AL in Contained Lisbon Parishes

Two income routes remain where AL is blocked in a contained Lisbon subsection. Long-term letting under the NRAU is taxed at a flat 28% on net income for non-residents and produces lower gross yield with far lower operating cost. Medium-term corporate and academic lets sit between the two.
...
For a comprehensive comparison of AL versus long-term rental returns in Lisbon, including net yield models under the moderate-rent incentive, see [Long-Term vs Holiday Rental Portugal](/guides/long-term-vs-holiday-rental-portugal/). For gross-to-net yield methodology across all Portuguese markets, see the [Portugal Rental Yield Guide](/guides/portugal-rental-yield-guide/) and [Gross vs Net Yield Portugal](/guides/portugal-rental-yield-guide/).

## How does Lisbon AL containment work in practice?

In the period since DL 76/2024, the recurring failure in Lisbon transactions has been AL status that was either misrepresented in marketing or misunderstood by the buyer.
...
**On the condominium veto wave:** Since DL 76/2024 came into force, several large residential buildings in Príncipe Real, Estrela, and Arroios have passed condominium resolutions blocking new AL registrations. In at least two cases known to Portuguese Estate, the resolution was passed immediately after a unit was sold, rendering the buyer's intended AL use impossible before they had even applied for a licence. Reviewing the condominium minutes for recent resolutions on AL is now standard due diligence in any Lisbon purchase.
...
## What containment does to a Lisbon valuation

RMAL containment turns a licence into part of the asset. In most central Lisbon parishes no new AL registration can be filed, so an existing, transferable registration carries a value the building itself does not. The practical difference on a €450,000 Alfama one-bedroom: with a live AL it might gross €30,000 a year, around 6.7%; without one it reverts to a long-term tenancy near €16,800, about 3.7%. That is roughly €13,000 of annual income riding on a document. Verify the registration is current and that the transfer mechanism is written into the CPCV, in a containment zone a lapsed registration cannot simply be re-filed after completion. Check the specific parish subsection rather than the municipality: containment is drawn at a level finer than most listings disclose.
