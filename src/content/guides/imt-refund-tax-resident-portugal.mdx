---
title: "Portugal IMT Refund for Tax Residents: 2026 Conditions"
...
readingTime: 11
featured: false
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/imt-refund-tax-resident-portugal/hero"
heroImageAlt: "The Portuguese Atlantic coast"
heroImageCredit: "Sergei Gussev / Wikimedia Commons"
heroImageLicence: "CC BY 2.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Coasts_of_Portugal_(31633068742).jpg"
heroImageWidth: 1280
heroImageHeight: 960
relatedSlugs: ["imt-tax-non-resident-portugal-2026", "cost-of-buying-property-portugal", "moderate-rent-tax-incentives-portugal-2026", "how-to-buy-property-portugal-step-by-step", "nif-portugal-property-purchase"]
faq:
  ...
  - question: "How much IMT can be refunded on a €500,000 Portuguese property purchase?"
    answer: "Under the flat 7.5% non-resident IMT rate effective September 2026, a €500,000 purchase generates €37,500 of IMT. If you establish Portuguese tax residency within 24 months and meet the 183-day test, the full €37,500 is potentially recoverable. Stamp duty of approximately €4,000 is separate and not refundable under the residency pathway."
  - question: "What are the most common reasons IMT refund applications are denied under DL 97/2026?"
    answer: "The four most common denial patterns are: updating your NIF address rather than obtaining a formal AT tax residency certificate; accumulating 183 days across two calendar years rather than within one; moderate-rent leases not registered with IHRU within 90 days of signing; and the property being purchased under a company name rather than as a natural person, which blocks the residency-based refund entirely."
---
...
<TldrBlock text="Refund is not automatic. You need documented tax residency, AT registration, and a formal claim before the 24-month window closes. Partial presence or US tax residency only = denial." />
...
Portuguese tax residency triggers on either 183 days of presence in a 12-month period or holding a habitual home in Portugal on 31 December. That status is what converts a non-resident buyer who paid flat 7.5% IMT into a resident entitled to the progressive bands, and it is the eligibility test the whole refund turns on.
...
An IMT refund application has to evidence two things: that the tax was paid at the non-resident rate, and that residency was established within the statutory window. That means the original IMT assessment and receipt, the escritura, the caderneta predial, and proof of residence registration and 183-day presence.
...
<InlineCta
  ...
  ctaId="guide_mid_imt_refund_tax_resident_portugal"
...
The refund runs on a clock rather than on demand. Residency must be established within 24 months of the purchase, the claim is made to the Autoridade Tributária after that status exists, and the amount recovered is the difference between the flat 7.5% paid and the progressive bands a resident would have paid.
...
Denials cluster around evidence rather than eligibility. Residency claimed but not registered, presence asserted without documentation, a claim filed outside the 24-month window, or a property that does not qualify as a permanent own residence account for most refusals rather than any dispute about the arithmetic.
...
The refund is the difference between two calculations on the same purchase price: flat 7.5% paid as a non-resident, and the progressive resident scale applied to that value. On a EUR 400,000 property the non-resident charge is EUR 30,000, and the recoverable amount is whatever that exceeds under the resident bands.
...
Non-resident purchasers face a heavier IMT charge, which is what makes the refund route worth pursuing:
- Flat 7.5% on the full acquisition value under DL 97/2026, with no progressive bands
- The reduced rates and exemptions available to residents do not apply
- The charge is the same whether the property is a first purchase or an addition to a portfolio

There is no separate percentage surcharge layered on top of the 7.5%: the flat rate *is* the non-resident charge.
...
Example 2: Higher-Value Property, Non-Resident Flat Rate
- Purchase price: €750,000
- Original IMT paid: €56,250 (flat 7.5% under DL 97/2026)
- Potential refund: €56,250
- Processing fees: €200
- Net refund: €56,050
...
## Why the refund is a plan, not an entitlement

Buying in Q4 2026 with a move planned for 2028 leaves the refund resting on a residency change that has not happened yet, and AT tests it on where you actually file, where an employer reports salary, and the record of your presence. If you keep primary ties abroad, budget as if the 7.5% IMT is permanent. Only treat refund as base-case when you have a signed lease or job transfer in Portugal before CPCV.
## Related guides

The IMT refund is one step in a residency decision that carries tax consequences well beyond the transfer tax. Becoming Portuguese tax resident triggers worldwide income taxation, changes the mortgage terms available, and starts the naturalisation clock, so the refund should never be the only reason to relocate.
...
The refund turns on evidence of residency rather than on intention, and the evidence is assembled over months. Where claims fail:

- The 24-month window is counted from the deed date, and buyers assume it runs from when they moved.
- The morada fiscal was never updated at Finanças, leaving no record that residency began.
- Days of presence are claimed without evidence, when flight records, utility bills and lease documents are what AT accepts.
- The property was let rather than occupied, which undermines a claim built on permanent habitation.

Insider tip: start the residency paper trail on the day of the escritura, not when you decide to claim. Utility contracts, the morada fiscal update and the 183-day count are all easier to evidence contemporaneously than to reconstruct two years later.
...
**Prevention**: confirm IHRU registration at the point the lease is signed, not when you apply for the refund. See [moderate-rent incentives](/guides/moderate-rent-tax-incentives-portugal-2026/) for the full registration workflow and required landlord declarations.
...
**Prevention**: buy in personal name if the refund is part of your investment thesis. Review [due diligence](/guides/due-diligence-portugal-property/) for ownership structure analysis and legal advice before committing to CPCV.

## From purchase to refund confirmation: the full timeline
...
Cross-reference [IMT reform hub](/guides/imt-tax-non-resident-portugal-2026/) for the non-resident rate comparison and [cost of buying](/guides/cost-of-buying-property-portugal/) for the total acquisition cost model to confirm the refund amount before you rely on it in your IRR projections.

## IMT refund planning checklist

Before you sign the CPCV, stress-test the refund assumption against these seven checkpoints:

1. Confirm the purchase is in personal name, not through a Portuguese or foreign company. Corporate ownership blocks the residency-based refund pathway entirely.
2. Verify the DL 97/2026 flat rate applies to your purchase date. The 7.5% non-resident rate is effective from September 2026; earlier purchases may fall under a different IMT schedule.
3. Calculate the 24-month deadline precisely from the escritura date, not the CPCV signing or reservation deposit payment.
4. Plan your 183-day calendar before you relocate. Identify which calendar year will be your qualifying year and build in margin for travel and family obligations that could reduce presence below threshold.
5. If you are using the moderate-rent lease pathway rather than personal residency, engage IHRU registration at lease signing, not later.
6. Open a Portuguese bank account and register with the SNS health system in your first 90 days. Both are among the fastest integration evidence items AT expects to see.
7. Keep a daily presence log from arrival. A spreadsheet recording location with supporting receipts, medical appointments, or bank activity is far easier to defend than reconstructed records two years later.

## What the refund is worth on a €500,000 purchase

The refund is the largest single sum a foreign buyer can recover in Portugal. On a €500,000 purchase a non-resident pays flat 7.5% IMT under DL 97/2026, €37,500. A buyer who becomes Portuguese tax resident within 24 months of the deed can reclaim the difference against the resident schedule, which on the same price produces a materially lower charge. The test is substantive, not a form: 183 days of physical presence in a calendar year, or a habitual abode in Portugal, evidenced by utility bills, municipal registration and AT records. Plan the residency date before the deed, because the 24-month clock starts at escritura and cannot be extended. Note that the refund route is not the only one: committing the property to a qualifying long-term lease can achieve a similar outcome without relocating.
