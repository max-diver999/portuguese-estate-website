...
<TldrBlock text="Portugal recorded 169,812 property sales (€41.2B) in 2025; prices +17.6%; non-resident purchases 8,471 (-13.3%). Simplex Urbanístico (DL 10/2024) merged prior urban approvals into one construction licence. Mais Habitação legacy: Golden Visa property route closed, AL containment active (DL 76/2024). PDM revisions still delay projects. Off-plan: warranty and energy class, but handover risk. Resale: immediate yield, higher licença de utilização risk. Non-residents pay flat 7.5% IMT from 1 Sep 2026 (DL 97/2026)." />
