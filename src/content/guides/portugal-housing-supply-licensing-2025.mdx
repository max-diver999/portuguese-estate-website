...
readingTime: 20
segment: invest
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/portugal-housing-supply-licensing-2025/hero"
heroImageAlt: "A residential building under construction on Avenida da Boavista, Porto"
heroImageCredit: "Ввласенко / Wikimedia Commons"
heroImageLicence: "CC BY-SA 3.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Cabo_da_Roca_-_Cape_Roca.JPG"
heroImageWidth: 1280
heroImageHeight: 993
faq:
...
<TldrBlock text="Full 2025 series: [the record year](/guides/portugal-property-market-record-2025-ine-data/).

2B) in 2025; prices +17.6%; non-resident purchases 8,471 (-13.3%). Simplex Urbanístico (DL 10/2024) merged prior urban approvals into one construction licence. Mais Habitação legacy: Golden Visa property route closed, AL containment active (DL 76/2024). PDM revisions still delay projects. Off-plan: warranty and energy class, but handover risk. Resale: immediate yield, higher licença de utilização risk. Non-residents pay flat 7.5% IMT from 1 Sep 2026 (DL 97/2026)." />
...
<InlineCta
  ...
  ctaId="guide_mid_portugal_housing_supply_licensing_2025"
...
## How do you score licensing risk on a specific file?

Scoring licensing risk before a CPCV means grading five things that a marketing brochure never mentions, and weighting them by what each one costs to fix after signature. The framework below is a working method rather than a market index, and it runs on documents any buyer can obtain.

| Check | Weight | Where it comes from | Cost if wrong |
|---|---|---|---|
| Licença de utilização matches actual use | 30% | Câmara municipal certificate | €8,000 to €35,000 to legalise |
| Licença de construção covers the as-built scope | 25% | Câmara file, compared to plans | Partial demolition in the worst case |
| PDM zoning and heritage overlays stable | 20% | Municipal PDM, câmara bulletins | Refused works licence later |
| AL registration path open at the address | 15% | RNAL plus containment-zone map | Income model fails entirely |
| Condominium accounts and pending works votes | 10% | Two years of accounts, AGM minutes | Assessment lands on the new owner |

Weight the first two most heavily because they are the two that can make a property unsaleable rather than merely more expensive. A file that fails either should be renegotiated or abandoned, not managed.

The public numbers set the context for all five. AICCOPN recorded 41,592 residential licences in 2025, up 20.1%, against 169,812 transactions worth €41.2 billion. Licensing volume is rising faster than completions, which means more properties now sit between permission and occupancy, and that gap is exactly where the utilização and construção mismatches live. Run the checklist on the parish, not on the national average.

## What to verify next: due diligence checklist

National supply data frames a market and settles nothing about a specific building. Licensing volumes tell you where competition for tenants will arrive in 3 to 5 years; the caderneta, the registry and the licença de utilização tell you whether the property in front of you is legal today.
...
Closing verification belongs with a Portuguese real estate lawyer, not the selling agent. Our [buy property as foreigner](/guides/how-to-buy-property-portugal-step-by-step/) and [Porto investment guide](/guides/porto-property-investment-guide/) pages link district context; this checklist links supply-side reform context.
...
## What 41,592 licences means for a buyer

AICCOPN recorded 41,592 new dwelling licences in 2025, a 20.1% increase, against 169,812 transactions and a 17.6% price rise (INE). Licences are a leading indicator: they precede completions by roughly two to three years, so the 2025 figure points at supply arriving through 2027 and 2028. That matters differently by location. New supply concentrates in Lisbon fringe parishes, Porto suburbs and Algarve resort phases, which moderates price growth in exactly those belts. Inland resale stock and constrained prime addresses see none of it. A buyer underwriting capital growth in a high-licence belt should assume competition from new product at resale, not scarcity. Check the municipal pipeline for the specific parish before pricing scarcity into an offer, because the national figure hides wide local variation.

## What 41,592 licences means for a buyer

AICCOPN recorded 41,592 new dwelling licences in 2025, a 20.1% increase, against 169,812 transactions and a 17.6% price rise reported by INE. Licences are a leading indicator: they precede completions by roughly two to three years, so the 2025 figure points at new supply arriving through 2027 and 2028. That matters very differently by location. New product concentrates in Lisbon fringe parishes, Porto suburbs and Algarve resort phases, which moderates price growth in exactly those belts. Inland resale stock and supply-constrained prime addresses see almost none of it. A buyer underwriting capital growth in a high-licence belt should assume competition from new-build at resale rather than continued scarcity, and should check the municipal pipeline for the specific parish before pricing scarcity into an offer.
