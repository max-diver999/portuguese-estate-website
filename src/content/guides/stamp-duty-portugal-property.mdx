...
readingTime: 12
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/guides/stamp-duty-portugal-property/hero"
heroImageAlt: "Castelo de Guimarães - Portugal — Portuguese stamp duty on property transfers"
heroImageCredit: "Vitor Oliveira from Torres Vedras, PORTUGAL / Wikimedia Commons"
heroImageLicence: "CC BY-SA 2.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Castelo_de_Guimar%C3%A3es_-_Portugal_(12217992163).jpg"
heroImageWidth: 1280
heroImageHeight: 853
relatedSlugs:
...
<TldrBlock text="Budget 0.8% stamp duty on the property price and 0.6% on the loan. On a €400,000 purchase with 70% mortgage, total stamp duty is about €4,880. Paid at completion via your lawyer. See also IMT and full closing costs guides." />
...
<InlineCta
  ...
  ctaId="guide_mid_stamp_duty_portugal_property"
...
| EU Non-Resident | 0.8% | 0.6% | Flat 7.5% IMT from Sep 2026 |
...
## How should stamp duty sit in your budget?

*Stamp duty is the most predictable element of Portuguese transaction costs. Unlike IMT calculations that can shift based on property valuations, the fixed 0.8%/0.6% rates allow precise budgeting from offer stage.*
...
For [Portuguese property investors](/guides/how-to-buy-property-portugal-step-by-step/), stamp duty represents a one-time acquisition cost that should be factored into total investment returns and break-even calculations.
...
Stamp duty sits alongside IMT and annual IMI in the total tax stack. Cross-read: [cost of buying property](/guides/cost-of-buying-property-portugal/), [IMT for non-residents 2026](/guides/imt-tax-non-resident-portugal-2026/), [CPCV contract](/guides/cpcv-promissory-contract-portugal/), [step-by-step purchase](/guides/how-to-buy-property-portugal-step-by-step/), [hidden costs](/guides/cost-of-buying-property-portugal/).


## Risks and red flags to check before you rely on this tax figure

Stamp duty is small enough that buyers stop checking it and large enough to matter on a mortgage. Where it is miscalculated:

- Only the 0.8% on the purchase price is modelled, and the 0.6% on a mortgage of five years or more is missed.
- Stamp duty is calculated on the declared price where the VPT is higher, and the tax office assesses on the higher figure.
- Gifts and inheritances between spouses, descendants and ascendants are exempt, but transfers to anyone else attract 10%.
- The duty is paid before the deed, not at it, and an unpaid guia stops the notary from proceeding.

Insider tip: stamp duty applies to the mortgage as well as the purchase, at 0.6% on loans of five years or more. A buyer modelling only the 0.8% on price understates the cash needed at the deed.
...
## The negotiation that is worth less than the calendar

Negotiating the purchase price by 2-3% is worth less than the completion date: completing one month after 1 September 2026 as a non-resident adds €15,000+ in IMT alone compared with progressive bands. If your CPCV allows, align escritura timing with your residency plan and IMT refund eligibility under [IMT refund rules](/guides/imt-refund-tax-resident-portugal/).
...
After completion, stamp duty does not recur. Annual ownership costs come from IMI property tax, with higher-value properties also triggering AIMI. For a complete view of the ongoing cost structure, cross-reference with [total hidden costs of buying](/guides/cost-of-buying-property-portugal/) and the [full cost of buying property guide](/guides/cost-of-buying-property-portugal/).

## Why reducing the declared price does not work

In the €400k-700k range the recurring mistake is effort spent reducing the declared purchase price by €5,000-10,000, thereby saving €40-80 in stamp duty, while missing the larger variable: whether the escritura falls before or after the residency confirmation that determines their IMT rate. Stamp duty is predictable and fixed: budget it precisely from your first offer, then focus advisory energy on IMT timing and residency status, where the real variance of €10,000-25,000 sits. For buyers anticipating Portuguese residency, coordinate residency confirmation with the escritura date to unlock [IMT refund eligibility](/guides/imt-tax-non-resident-portugal-2026/); the refund potential typically reaches 10-20 times the total stamp duty bill on a mid-market purchase.

## What stamp duty adds on a financed purchase

Stamp duty is small individually and easy to under-budget when a mortgage is involved, because it applies twice. On a €350,000 purchase with a €245,000 mortgage at 70% loan-to-value, the property transfer attracts 0.8% of price, €2,800. The mortgage deed attracts a further 0.6% of the loan amount, €1,470. Total stamp duty is €4,270, not the €2,800 a buyer modelling the purchase alone would expect. Both are payable by the buyer, both are non-negotiable, and neither varies by nationality or residency — unlike IMT, which for non-residents is a flat 7.5% from September 2026. Budget stamp duty alongside IMT rather than treating it as a closing-cost afterthought. Both charges settle at the deed alongside IMT, so hold the full amount in euros before the completion date rather than converting late.
