---
title: "Buying or Renting on a Portugal D7 Visa: 2026 Costs"
description: "Whether to rent or buy once you hold a Portugal D7 visa: NIF, CPCV, the flat 7.5% non-resident IMT, the 183-day test and the IMT refund route."
pubDate: 2026-06-17
...
readingTime: 22
featured: true
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/portugal/guides/portugal-d7-visa-property/hero.webp"
heroImageAlt: "Anchored small boats, Ria Formosa, Faro"
heroImageCredit: "Jules Verne Times Two / Wikimedia Commons"
heroImageLicence: "CC BY-SA 4.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Anchored_small_boats,_Ria_Formosa,_Faro,_Portugal_julesvernex2.jpg"
heroImageWidth: 1280
heroImageHeight: 959
relatedSlugs:
...
faq:
  ...
  - question: "What income do I need to prove for Portugal D7 visa in 2026?"
    answer: "The main applicant must show stable passive income at or above the Portuguese minimum wage reference, approximately €920 per month in 2026. A spouse typically adds 50% of that threshold, and each dependent child adds about 30%. Pensions, dividends, rental income from outside Portugal, and certain annuities qualify; active salary from a Portuguese employer does not."
...
|---|---|
| Single main applicant | €920 |
| Main applicant + spouse | €920 + €435 (50%) ≈ €1,305 |
...
|---|---|---|---|
| Core requirement | ~€920/month passive income (2026 ref.) | €500,000 in qualifying fund, 5-year lock | ~€3,680/month remote employment income (4× minimum wage) |
...
| Path to citizenship | 10 years + A2 Portuguese (7 if EU or CPLP) | Same | Same |
...
No. The D7 requires evidence of accommodation in Portugal, and a 12-month arrendamento lease satisfies that requirement exactly as ownership does. D7 residents renew AIMA permits indefinitely on a lease, and buying is a separate financial decision rather than an immigration one.
...
4. **Liquidity.** Deposit, IMT, stamp duty, legal fees, and furniture can consume 15% of purchase price in cash on top of the CPCV sinal, and renting preserves that buffer for healthcare, travel, and AIMA fees.
...
<InlineCta
  ...
  ctaId="guide_mid_portugal_d7_visa_property"
...
The rent-or-buy decision turns on the 24-month IMT refund window rather than on preference. A non-resident buyer pays flat 7.5%; a buyer who becomes tax resident within 24 months reclaims the difference against the progressive bands. Buying before that status exists costs real money on a EUR 500,000 purchase.
...
| Passive income tight above €920 threshold | Strong: lower upfront cash | Risky: CPCV deposit + closing costs strain visa renewal proof |
...
The purchase mechanics for a D7 holder match any foreign buyer. Immigration status does not shorten due diligence or exempt you from IMT. Follow the sequence in our [buy property in Portugal as a foreigner](/guides/how-to-buy-property-portugal-step-by-step/) guide; the D7-specific wrinkles are timing and tax domicile.
...
The escritura transfers title. Funds move through the notary's blocked account or bank cheques. Registration at the Conservatória follows within days, and you receive keys after confirmation of clear funds and tax payments.
...
A D7 visa does not make you Portuguese tax resident, and conflating the two is the most consequential error on this page. The Autoridade Tributária applies its own tests: 183 days of presence in a 12-month period, or a habitual home in Portugal on 31 December.
...
The refund and the visa timetable can be sequenced three ways:
...
Budget the full cash stack before signing CPCV. D7 income proof at €920 per month does not cover a surprise €40,000 IMT bill on a €500,000 apartment.
...
Portuguese banks lend to D7 holders, and the terms follow tax residence rather than visa status. A non-resident typically borrows up to 70% to 80% of value; a resident borrower reaches higher ratios and better pricing. Establishing residency before the mortgage application therefore changes the deal twice over.
...
**Buying before NIF and bank account.** Sellers and agents cannot draft a compliant CPCV without your NIF, so any delay in Finanças registration adds weeks.
...
**Counting partial years toward 183 days without logs.** Keep entry stamps, flight records, and utility bills, because AT denies refunds when evidence is thin.
...
**Skipping independent legal counsel.** Developer-linked lawyers create conflicts, which is why you should always retain your own solicitor.

## Three ways the D7 and the purchase collide

The visa and the purchase run on separate clocks, and three collisions between them account for most of the trouble:
...
Five items decide whether a D7 and a purchase can run together safely: the consulate appointment date, the AIMA permit timeline, the 24-month IMT refund window, the accommodation evidence the visa needs, and whether the mortgage is being applied for as a resident or a non-resident.

- [ ] Passive income documentation covers 12 to 24 months with consistent credits
- [ ] Personal NIF obtained (a fiscal rep placeholder alone is insufficient)
