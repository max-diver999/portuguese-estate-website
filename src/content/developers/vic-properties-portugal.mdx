...
readingTime: 24
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/portugal/developers/vic-properties-portugal/hero.webp"
heroImageAlt: "Prainha do Braço de Prata, Lisboa"
heroImageCredit: "Vitor Oliveira from Torres Vedras, PORTUGAL / Wikimedia Commons"
heroImageLicence: "CC BY-SA 2.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Prainha_do_Bra%C3%A7o_de_Prata_-_Lisboa_-_Portugal_(52738127474).jpg"
heroImageWidth: 1280
heroImageHeight: 842
relatedSlugs:
...
Disclaimer: Portuguese Estate Editorial provides research only and does not give investment, tax or legal advice. Figures cite public company statements, regulatory statistics and sector press unless noted. Confirm all data with your lawyer and advisers before signing a CPCV, and note that past delivery at one phase does not guarantee future schedule performance.
...
Do not confuse VIC Properties (Portugal) with VICI Properties (US REIT); search-engine ambiguity between the two names has already routed investors to the wrong filings.
...
Matinha is described as one of Portugal's largest residential-led mixed-use approvals, with c. €2.0 billion gross development value cited and 3,000+ direct jobs referenced in company materials. First acquisition dates to 2019; approval announcements followed in subsequent years. Scale implies multi-cycle execution over a decade rather than a single handover date.

Delay risk on Matinha is inherently higher than on a 15-unit boutique building. Infrastructure coordination, utility relocation and municipal interface multiply critical paths, so underwrite patience and capital lock-up accordingly.

### Pinheirinho (Comporta/Melides)

Pinheirinho sits in the Comporta/Melides corridor where environmental sensitivity and seasonal demand shape holding strategies. VIC's post-2023 capital plan emphasised continued investment in Comporta/Melides alongside Lisbon projects. Coastal masterplans face licensing scrutiny and tourism infrastructure timing distinct from Lisbon apartment lettings. Branded-resort buyers should also read our [Six Senses Comporta project review](/projects/six-senses-comporta/) for villa pricing bands, rental assumptions and off-plan controls on that scheme.
...
Request disclosure of any debt facilities secured on the phase you buy. Institutional ownership does not automatically mean the project itself carries no debt.
...
Longstop date: Calendar deadline with clear refund path via guarantee, and no vague "subject to licensing" language without remedy.
...
Penalty symmetry: Developer delay remedies written in alongside the buyer default acceleration clauses.
...
Scenario 4 is particularly weak: large phases can flood local resale at similar completion windows. Under Scenario 6, the deal is unacceptable regardless of institutional ownership.
...
3. Alvará de construção valid for building; masterplan marketing alone does not count.
...
Pause if any item fails; reputation and institutional capital do not substitute for a failed check.
...
Buyers often cross-shop VIC against other national platforms marketing Lisbon and coastal masterplans. Compare project by project, whatever logo sits on the brochure:
...
Pinheirinho buyers comparing Comporta lifestyle with Algarve resort stock should read the [Algarve property investment guide](/guides/algarve-property-investment-guide/) side by side with Comporta parish data instead of relying on brochure lifestyle imagery alone.
...
## Large-scale regeneration: what changes in the due diligence

Master-planned regeneration schemes shift the risk from the building to the phasing, and that changes what a buyer needs to verify. A single tower either completes or it does not; a multi-phase riverfront district delivers over several years, and the amenity that justified the asking price often lands in a later phase than the apartment being sold today. Check which phase your specific unit sits in, what the longstop date is for that phase rather than for the masterplan as a whole, and whether the Decreto-Lei 67/2003 guarantee actually covers your tranche of payments. Portugal recorded 8,471 non-resident purchases in 2025, down 13.3% year on year (INE), so absorption assumptions written into a launch brochure may no longer hold. Underwrite on the phase you are buying, never on the render of the finished district.
