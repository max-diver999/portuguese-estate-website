...
readingTime: 26
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/portugal/developers/farinvest-properties-portugal/hero.webp"
heroImageAlt: "Praça Duque de Saldanha and Avenida da República, Lisbon"
heroImageCredit: "Vitor Oliveira from Torres Vedras, PORTUGAL / Wikimedia Commons"
heroImageLicence: "CC BY-SA 2.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Marina_de_Vilamoura_-_Portugal_(4790285971).jpg"
heroImageWidth: 1280
heroImageHeight: 960
relatedSlugs:
...
This matters for guarantee verification. DL 67/2003 certificates must reference the developer seller receiving staged payments; a certificate that names only the introducing agency does not meet that requirement. A buyer purchasing Lisbon off-plan via an Algarve broker still needs Lisbon municipal licensing context, IMPIC filings for that specific development and comparables from the target parish.
...
National statistics frame every intermediary sale. INE reported a record transaction year in 2025 with 17.6% year-on-year price growth, while absolute deal values on coastal stock remained elevated. Full 2025 series: [the record year](/guides/portugal-property-market-record-2025-ine-data/). AICCOPN cited 41,592 new dwelling licences in 2025, up 20.1%, with mortgage origination around €23.325 billion, up 31.1%.

Full 2025 series: [the record year](/guides/portugal-property-market-record-2025-ine-data/).

Algarve buyers feel these trends through entry price movement on villas and marina apartments, whatever agency brand sits on the listing. Increased licensing nationally signals more competing new-build supply arriving over two to four years. That can support resale liquidity in prime corridors or compress margins on generic apartments depending on parish absorption.
...
Cross-read the [off-plan property Portugal guide](/guides/off-plan-property-portugal-guide/) for milestone tables that apply to the underlying developer rather than to the introducing agency.
...
Seller identity block: Must state the legal entity liable for completion. "Farinvest Properties" marketing shorthand only belongs there if Farinvest is genuinely the licença holder for that phase (unusual given registry activity).

Longstop date (data limite de conclusão): Calendar-specific with remedies and refund paths tied to guarantee claim procedure, with any open-ended licensing language removed from the draft.
...
Penalty and rescission symmetry: Confirm buyer termination rights when milestones slip, alongside the developer remedies that apply if mortgage steps delay.
...
Scenario D is the highest-frequency mistake: conflating agency reputation with construction obligor strength. For Scenario F, ask for the same documentation pack you would demand from a Lisbon sales centre, plus clarity on who earns the mediation commission.
...
Agency longevity since 1964 can coexist with any single red flag on a given plot. Evaluate the specific transaction on its own documents as well as the brand age.
...
2. Licença de construção: Valid alvará for the exact building phase; a master plan alone does not cover it.
...
11. Lawyer engagement: Portuguese counsel engaged before any reservation fee is paid.
...
Request a complete data room that goes well beyond a lifestyle brochure:
...
Re-verify seller entity, guarantee certificates and completion dates at CPCV stage because brokered inventory changes with developer capital decisions and plot sales.
...
If steps 1 to 3 align and guarantees are active, agency introduction is commercially fine. If any step fails, the transaction is a developer problem surfaced through an agency channel, and DL 67/2003 discipline still applies in full.
...
## What a brokerage due diligence check actually covers

Brokerage due diligence in Portugal turns on one distinction: whether the counterparty is selling its own stock or introducing someone else's. AMI licensing through IMPIC is the first check, and the licence number should appear on every listing and on the CPCV itself. AICCOPN counted 41,592 new dwelling licences in 2025, up 20.1% year on year, so the number of active intermediaries has grown faster than the track record available to verify any of them. Confirm that the AMI number is current, that the entity named on the CPCV matches the owner recorded on the land registry, and that any commission arrangement is disclosed in writing before you sign anything. A broker introducing stock owes no warranty on the building itself; the developer named on the licença does.
