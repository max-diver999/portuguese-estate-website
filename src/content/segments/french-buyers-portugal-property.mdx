...
faq:
  ...
  - question: "How is rental income from Portugal taxed for French tax residents?"
    answer: "French tax residents typically declare Portuguese rental income in France under the Franco-Portuguese tax treaty, while Portugal may withhold 28% on non-resident rental at source depending on structure. Net yield models must include both Portuguese withholding and French impôt reporting. Consult a cross-border accountant before buying an income-focused Algarve unit."
  - question: "Should French buyers purchase through an SCI or in personal name?"
    answer: "Personal name is standard for a French second home and simplifies Algarve resale. An SCI (or Portuguese company) adds accounting cost and triggers company-level AIMI at 0.4% on full VPT without the €600,000 individual threshold. Use a company only when inheritance or multi-owner family structure clearly benefits from it—not for a single holiday flat."
---
...
French buyers usually need the tax comparison before the market one: read [Portugal versus France](/compare/portugal-vs-france-property-investment/) alongside the [Portugal property investment guide](/guides/portugal-property-investment-guide/).
...
French buyers usually arrive with the tax question already half-answered and the licensing question untouched. The France-Portugal treaty allocates taxing rights on property income to Portugal, so a rental yield model runs on Portuguese rates of 25% on long leases, and French wealth tax on real estate still reaches Portuguese holdings. Settle the residency intention first, because it determines whether the 7.5% non-resident IMT is a permanent cost or a refundable one.
...
<InlineCta
  ...
  whatsappMessage="Hi Portuguese Estate! I'm from France and want Portugal property guidance."
/>
...
When you sell, Portugal taxes 50% of the net gain at progressive IRS rates of 14.5% to 48% — the same treatment residents receive, in force since 1 January 2023 after the Court of Justice of the EU struck down the earlier flat 28% charge on the full gain (Case C-388/19). France may also tax the gain as immovable property abroad for residents, with mechanisms to avoid double taxation through tax credits. Holding period, improvement invoices, and purchase costs (including IMT) affect the Portuguese calculation. French sellers who bought before the 2026 IMT reform should model exit tax with both jurisdictions before listing.
...
| Capital gain on sale | 50% of net gain at 14.5–48% IRS | Abroad property gain reporting; credit system |
...
Negotiate the price, sign the CPCV and pay the sinal of 10% to 30%. Insert an inventory annex if furniture is included, and confirm at this stage whether you will claim Portuguese tax residency, since it decides the IMT treatment.
