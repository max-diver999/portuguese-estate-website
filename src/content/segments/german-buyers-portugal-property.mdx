...
German demand concentrates inland, so pair the national picture in the [Portugal property investment guide](/guides/portugal-property-investment-guide/) with the works budgeting in [renovation costs per square metre](/guides/renovation-costs-portugal-per-m2/).
...
German demand concentrates inland and on the western Algarve rather than on the resort strip, which changes the underwriting. Properties in the Monchique and Silves belts are cheaper per square metre and slower to sell, water supply is a genuine variable rather than a formality, and access roads matter to both insurance and resale. Verify the water source, the licence and the road classification before the deposit, because retrofitting any of the three is expensive.
...
<InlineCta
  ...
  whatsappMessage="Hi Portuguese Estate! I'm from Germany and researching Portugal property investment."
/>
...
When you sell, Portugal taxes 50% of the net gain at progressive IRS rates of 14.5% to 48% — the same treatment residents receive, in force since 1 January 2023 after the Court of Justice of the EU struck down the earlier flat 28% charge on the full gain (Case C-388/19). Germany may tax the gain on immovable property abroad for residents, with mechanisms to avoid double taxation through tax credits under the DTA. Holding period, improvement invoices, and purchase costs (including IMT) affect the Portuguese calculation. German sellers who bought before the 2026 IMT reform should model exit tax with both jurisdictions before listing.
...
| Capital gain on sale | 50% of net gain at 14.5–48% IRS | Abroad property gain; credit system |
...
Negotiate the price, sign the CPCV and pay the sinal of 10% to 30%. On inland and rural purchases, make the CPCV conditional on the water source, the access road classification and the licença de utilização, all of which are expensive to fix afterwards.
...
## What the purchase actually costs German buyers

Cash-to-close for German buyers works out as follows on a €335,640 purchase, the INE non-resident average. A non-resident completing from 1 September 2026 pays flat 7.5% IMT of €25,173 under DL 97/2026, 0.8% stamp duty of €2,685, and roughly 2.5% in legal, notary and registry fees of €8,391. That is €36,249 on top of the price, or 10.8%, so the real capital requirement is €371,889. An EU passport removes one cost the non-EU cohorts carry: the NIF issues at Finanças without a fiscal representative, saving €150 to €500 a year. It does not change the tax: IMT is set by tax domicile, so an EU buyer domiciled outside Portugal pays the same flat 7.5%. German buyers concentrate on the Algarve and Silver Coast, where the same flat rate applies to a lower average ticket than the UK or US cohorts face.
