...
<TldrBlock text="US buyers = €479,403 avg transaction (INE 2025). Fiscal rep required for NIF without PT address (€150–500/yr). Non-EU mortgage 70–80% LTV, 3.13% avg rate (AICCOPN Dec 2025). IMT 7.5% flat from Sep 2026. Algarve = 42.4% non-res deal value. Residency: D7 (~€920/mo passive income), D8 remote work, or €500k GV fund — not property alone. FATCA/FBAR reporting applies. Budget 10–13% closing costs. Allow 10–16 weeks remote timeline." />

<ImtCostCallout title="What a US non-resident buyer pays at completion" />

<InlineCta
  headline="US buyer? Get a shortlist with your IMT number attached."
  subtext="Free shortlist of 3-5 vetted properties plus IMT and net yield estimate within 1 business day."
  ctaId="inline_us_buyers_top"
  whatsappMessage="Hi Portuguese Estate! I'm a US buyer and I want a Portugal shortlist with IMT and net yield numbers."
/>
...
American buyers should read the residency routes before the market data: [residency options without the Golden Visa](/guides/portugal-residency-options-without-golden-visa/) and then the [Portugal property investment guide](/guides/portugal-property-investment-guide/).
...
American buyers carry two frictions that European buyers do not. Portugal taxes on residence while the United States taxes on citizenship, so a US owner files in both systems and relies on the treaty and foreign tax credits rather than on an exemption, and FATCA reporting makes some Portuguese banks slower to open accounts. Budget extra weeks for the account and the NIF, and take cross-border tax advice before the CPCV, not after completion.
...
<InlineCta
  ...
  whatsappMessage="Hi Portuguese Estate! I'm a US buyer researching Portugal property and need tax/legal guidance."
/>
...
When you sell, Portugal taxes 50% of the net gain at progressive IRS rates of 14.5% to 48% — the same treatment residents receive, in force since 1 January 2023 after the Court of Justice of the EU struck down the earlier flat 28% charge on the full gain (Case C-388/19). The United States may also tax the gain on overseas property for US persons, with foreign tax credit mechanisms to reduce double taxation when both jurisdictions claim taxing rights. Holding period, improvement invoices, and purchase costs including IMT affect the Portuguese calculation. US sellers should model exit tax with both jurisdictions before listing.
...
| Capital gain on sale | 50% of net gain at 14.5–48% IRS | US capital gains reporting; foreign tax credit |
...
| D7 passive income visa | ~€920/month income proof | Optional home purchase |
...
Negotiate the price, sign the CPCV and pay the sinal of 10% to 30%. American buyers should have the NIF and a Portuguese account already open at this point, because FATCA checks slow both, and add an inventory annex if furniture is included.
...
## What the purchase actually costs US buyers

Cash-to-close for US buyers works out as follows on a €479,403 purchase, own INE average. A non-resident completing from 1 September 2026 pays flat 7.5% IMT of €35,955 under DL 97/2026, 0.8% stamp duty of €3,835, and roughly 2.5% in legal, notary and registry fees of €11,985. That is €51,776 on top of the price, or 10.8%, so the real capital requirement is €531,179. Being outside the EU adds a fiscal representative at €150 to €500 a year — mandatory to hold a NIF without a Portuguese address — and caps most mortgage offers at 70–80% LTV against the 90% a resident can reach. The representative is a compliance address for AT correspondence, not an adviser; it can be dropped the moment you register a Portuguese address as a resident.
