...
heroImageAlt: "View of Porto from View of Porto from Vila Nova de Gaia — Porto versus Lisbon"
...
Before paying reservation money, cross-read the [complete before September 2026 IMT guide](/guides/complete-before-september-2026-imt-guide/) for timing, the [Portugal CPCV deposit guide](/guides/portugal-property-deposit-guide-cpcv/) for deposit risk, and the [non-resident mortgage Portugal guide](/guides/non-resident-mortgage-portugal/) for loan constraints. Those three operational guides decide whether a Porto or Lisbon preference can actually close.
...
Abstract rankings become useful when anchored to identical capital. Assume a non-resident cash buyer with €500,000 and price the same specification in both cities: in Porto that budget reaches prime parishes, in Lisbon it buys a smaller unit outside them, and the two outcomes have different exit profiles.
