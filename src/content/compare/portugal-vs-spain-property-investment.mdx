...
readingTime: 16
segment: invest
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/compare/portugal-vs-spain-property-investment/hero"
heroImageAlt: "The Werneck house in Viana do Castelo — Portugal compared with Spain"
heroImageCredit: "Krzysztof Golik / Wikimedia Commons"
heroImageLicence: "CC BY-SA 4.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Werneck_house_in_Viana_do_Castelo_(1).jpg"
heroImageWidth: 1280
heroImageHeight: 941
faq:
...
Cross-read next: [the Lisbon investment guide](/guides/lisbon-property-investment-guide/) and [Porto](/guides/porto-property-investment-guide/), the two cities Spanish buyers weigh against Madrid and Valencia on price per square metre.

## Rental yields: Lisbon, Porto, Algarve vs Madrid, Barcelona, Costa del Sol

Yield is the metric most investors cite first and model last. Against Spain the gross figures are close, and the decision usually turns on letting regulation instead: Portuguese AL containment is municipal, Spanish tourist licensing is regional and changes faster.

Portugal's yield bands sit close to Spain's on the headline numbers: 4.3% to 4.6% gross in established Lisbon neighbourhoods against broadly similar figures in Valencia and Málaga. The divergence appears after tax, where Portugal's 25% autonomous rate on long lets compares with a Spanish regime that allows deductible expenses for resident landlords and restricts them for non-EU ones.
...
<InlineCta
  ...
  whatsappMessage="Hi Portuguese Estate! I read your Portugal vs Spain comparison and want Portugal property guidance."
/>

## Acquisition taxes and all-in closing costs

Transfer tax is where the comparison turns on geography rather than nationality. Portugal applies one flat 7.5% to non-residents nationwide, while Spain's ITP is set by each autonomous community and ranges roughly 6% to 10%, so the Spanish figure depends on which region you buy in rather than on where you are tax resident.

Portugal charges non-residents a flat 7.5% IMT on residential purchases from 1 September 2026 under DL 97/2026. Spain's ITP on resale property is set regionally and typically runs 6% to 10%, so the headline burden is comparable and the regional variation is what distinguishes the two.
...
Short-let policy decides whether a yield projection survives contact with the town hall, and the two countries devolve it differently. Portugal's containment is municipal and relatively stable once published; Spain's tourist-let licensing is regional and has moved repeatedly in Catalonia, the Balearics and Andalusia, which makes a Spanish model more exposed to rule change than a Portuguese one.
...
Portugal published 169,812 residential transactions for 2025 with a 17.6% price index rise. Spain's registry data is equally accessible, so neither market has a transparency advantage; the difference is that Portugal's is a smaller market and moves further on the same absolute volume of foreign money.
...
Freehold ownership without nationality restrictions, a civil-law notarial system and EU membership apply on both sides of the border. The meaningful difference for a foreign buyer is tax residence, since Spain levies a wealth tax that several regions have effectively neutralised and others have not.

The Algarve takes 42.4% of Portugal's non-resident deal value, a concentration that has no single Spanish equivalent because foreign demand there splits across the Costa del Sol, the Costa Blanca, the Balearics and the Canaries. Portugal offers one deep market; Spain offers four shallower ones with different regulatory regimes.
...
The flat 7.5% raises entry cost materially: €37,500 on a €500,000 purchase, against €30,000 to €50,000 of Spanish ITP on the same money depending on the autonomous community. Region choice in Spain moves the number as much as residency choice does in Portugal.

The Golden Visa property route closed in October 2023. Spain ended its own golden visa in 2025, so neither country now offers residency through a property purchase, and both push the same buyers toward income-based or investment-fund routes.

NHR closed to new applicants at the end of 2024, and IFICI replaced it with a narrow professional qualification. Spain's Beckham regime is similarly employment-linked, so the two countries now compete for the same relocating professional rather than for the same retiree.

AL containment in Lisbon and parts of Porto limits new short-let supply, which supports existing licences and closes the route for new buyers. Spain's larger cities have taken comparable steps, so this is a shared direction of travel rather than a Portuguese peculiarity; the difference is that Spanish rules change at regional rather than municipal speed.

The 17.6% price rise in 2025 compresses yield on new money. Spanish coastal markets moved strongly too, so the yield compression is not a Portugal-specific problem; the question is which market has more room left rather than which has risen less.
...
Abstract rankings become useful when anchored to identical capital. Assume a non-resident cash buyer with €500,000 and run both markets to the same completion date, choosing a specific Spanish region, because ITP and any wealth tax vary enough between them to reverse the conclusion.
...
Entry tax dominates the spreadsheet, exit liquidity determines the outcome. Spain's larger market and deeper domestic buyer base generally clears a resale faster than Portugal's, and that difference matters more than the two or three points separating ITP from IMT on the way in.

Both countries publish usable foreign-buyer statistics, so neither has a transparency edge. INE recorded 8,471 Portuguese non-resident purchases in 2025, down 13.3%; Spanish registry data shows foreign buying holding a materially larger share of a much larger market, which is the scale difference in one figure.
...
Nationality alone should not pick the country; tax residence, language, financing, and exit buyer pool should. ### United Kingdom buyers
...
UK buyers financing either market should secure pre-approval before CPCV or arras. See [non-resident mortgage Portugal](/guides/portugal-mortgage-rates-foreigners-2026/) for the Portuguese path.
...
## Portugal purchase process: what to read next

If the comparison points toward Portugal, the next step is the purchase sequence itself: [how to buy property in Portugal](/guides/how-to-buy-property-portugal-step-by-step/), then the [cost stack](/guides/cost-of-buying-property-portugal/) and the [IMT position for non-residents](/guides/imt-tax-non-resident-portugal-2026/).

| Step | Guide | What it covers |
|---|---|---|
| Eligibility | [Buy property Portugal foreigner](/guides/how-to-buy-property-portugal-step-by-step/) | National framework for non-residents |
...
| Finance | [Non-resident mortgage Portugal](/guides/portugal-mortgage-rates-foreigners-2026/) | LTV, banks, timelines |
...
Cross-border comparisons fail when due diligence stops at portal photos. Apply the checklist below in both markets, and check the Spanish nota simple against the Portuguese certidão permanente with equal care, since neither guarantees the absence of undeclared works.
...
Where Portugal wins the comparison, the next reads are [the Portuguese purchase process step by step](/guides/how-to-buy-property-portugal-step-by-step/) and [the rules on foreign ownership](/guides/can-foreigners-buy-property-portugal/).
...
For within-Portugal routing, see [Algarve vs Lisbon property investment](/compare/algarve-vs-lisbon-property-investment/) and [Lagos vs Vilamoura investment](/compare/lagos-vs-vilamoura-investment/).
