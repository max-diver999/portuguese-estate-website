...
readingTime: 18
segment: invest
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/f_auto,q_auto,w_1280/more-group/portugal/compare/portugal-vs-italy-property-investment/hero"
heroImageAlt: "Praia de Armação de Pêra, 09 May 2016 — Portugal versus Italy"
heroImageCredit: "Kolforn / Wikimedia Commons"
heroImageLicence: "CC BY 3.0"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Praia_de_Arma%C3%A7%C3%A3o_de_P%C3%AAra,_09_May_2016.JPG"
heroImageWidth: 1280
heroImageHeight: 960
faq:
...
Cross-read next: [the Lisbon investment guide](/guides/lisbon-property-investment-guide/) for capital-city district yields and [the Algarve guide](/guides/algarve-property-investment-guide/) for the coastal market Italian buyers most often compare against Puglia and Sicily.

## Rental yields: Lisbon, Porto, Algarve vs Rome, Milan, Italian coasts

Yield is the metric most investors cite first and model last. Against Italy the difference is rarely the gross figure; it is that Italian running costs carry IMU on second homes and a heavier notarial layer, so the same gross yield nets differently.
...
<InlineCta
  ...
  whatsappMessage="Hi Portuguese Estate! I read your Portugal vs Italy comparison and want Portugal investment help."
/>
...
Portugal charges non-residents a flat 7.5% IMT on residential purchases from 1 September 2026 under DL 97/2026. Italy's registration tax on a second home from a private seller is 9% of the cadastral value rather than the price, which frequently produces a lower absolute charge on an equivalent property.
...
Portugal published 169,812 residential transactions for 2025 with a 17.6% price index rise, and INE releases the series at regional level. Italy's Agenzia delle Entrate publishes comparable data on a longer lag, which matters when timing an entry rather than describing a market.
...
Freehold ownership without nationality restrictions, a civil-law notarial system and EU membership give both countries legal predictability. The practical divergence is speed: a Portuguese purchase completes in weeks once the file is clean, while an Italian one is slowed by the preliminare and the notaio's searches.
...
The flat 7.5% raises entry cost materially: €37,500 on a €500,000 purchase, against roughly €22,500 of Italian registration tax on a comparable second home valued on its cadastral base. The gap narrows sharply if the buyer takes Portuguese tax residency and reclaims the IMT.

The Golden Visa property route closed in October 2023, so buyers wanting residency alongside property use the €500,000 fund route or the D7 and D8 visas. Italy's elective residence visa has no investment threshold at all but requires demonstrable passive income and grants no work rights.

NHR closed to new applicants at the end of 2024, and IFICI replaced it with a much narrower qualifying list. Italy's flat-tax regime for new residents remains open at €200,000 a year on foreign income, which suits a different and considerably wealthier profile.
...
The 17.6% price rise in 2025 compresses yield on new money and lengthens payback for income buyers. Italian prices moved far less over the same period, which is the core of the trade: Portugal offers momentum, Italy offers a lower entry against a slower market.
...
Abstract rankings become useful when anchored to identical capital. Assume a non-resident cash buyer with €500,000 and run both markets to the same completion date, including Italian registration tax on the cadastral base rather than the price, which is the line most comparisons get wrong.
...
For Portuguese closing-cost detail, use [cost of buying property in Portugal](/guides/cost-of-buying-property-portugal/) and [IMT tax non-resident 2026](/guides/imt-tax-non-resident-portugal-2026/). For rental net math on the Portuguese side, see [Portugal rental yield guide](/guides/portugal-rental-yield-guide/) and [gross vs net yield Portugal](/guides/portugal-rental-yield-guide/).
...
UK buyers financing either market should secure pre-approval before CPCV or compromesso. See [non-resident mortgage Portugal](/guides/portugal-mortgage-rates-foreigners-2026/) for the Portuguese path.
...
If this comparison points you toward Portugal, the conveyancing sequence is documented across our purchase process guides. Read these in order before paying any deposit:
...
Cross-border comparisons fail when due diligence stops at portal photos. Apply the checklist below in both markets, and note that Italian searches routinely surface inheritance splits among multiple heirs, a complication Portuguese registry entries show more plainly.
...
If Portugal is the side you settle on, work through [the step-by-step purchase process](/guides/how-to-buy-property-portugal-step-by-step/) next, and check [whether foreigners can buy property in Portugal](/guides/can-foreigners-buy-property-portugal/) for the ownership rules.
